...
replace github.com/absolutelightning/go-immutable-adaptive-radix => ../go-immutable-adaptive-radix-tree

require (
	github.com/NYTimes/gziphandler v1.0.1
	github.com/absolutelightning/go-immutable-adaptive-radix v1.0.17
	github.com/absolutelightning/go-memdb v1.0.6
