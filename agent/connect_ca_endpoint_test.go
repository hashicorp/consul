...
func Test_writeCA(t *testing.T) {
	...
	tests := []struct {
		...
		{"root + 2 intermediates with carriage", args{roots: []*structs.CARoot{{RootCert: caCarriage, IntermediateCerts: []string{caCarriage, caCarriage}}}}, expected, false},
		{"root + 2 intermediates no carriage", args{roots: []*structs.CARoot{{RootCert: ca, IntermediateCerts: []string{ca, ca}}}}, expected, false},
		{"root + 2 intermediates mixed", args{roots: []*structs.CARoot{{RootCert: caCarriage, IntermediateCerts: []string{caCarriage, ca}}}}, expected, false},
		{"root only", args{roots: []*structs.CARoot{{RootCert: caCarriage}}}, expectedRoot, false},
	}
