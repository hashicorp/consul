// generated by deep-copy -pointer-receiver -o ./proxycfg.deepcopy.go -type ConfigSnapshot -type ConfigSnapshotUpstreams -type configSnapshotConnectProxy -type configSnapshotIngressGateway -type configSnapshotMeshGateway -type configSnapshotTerminatingGateway -type PeerServersValue ./; DO NOT EDIT.
		...
		for k2, v2 := range o.PeeringServices {
			...
			if v2 != nil {
				...
				for k3, v3 := range v2 {
					...
					cp_PeeringServices_v2_v3.Nodes = v3.Nodes.DeepCopy()
