			...
			stages: []verificationStage{
				...
				},
				{
					...
					verifySnapshot: func(t testing.TB, snap *ConfigSnapshot) {
						...
						require.Contains(t, snap.ConnectProxy.WatchedUpstreamEndpoints[api.String()], "api.default.default.dc1")

						// THe endpoint and passthrough address for proxy1 should be gone.
						require.Equal(t, snap.ConnectProxy.WatchedUpstreamEndpoints[api.String()]["api.default.default.dc1"],
							structs.CheckServiceNodes{
								{
									Node: &structs.Node{
										Datacenter: "dc1",
				...
				},
				{
					...
					verifySnapshot: func(t testing.TB, snap *ConfigSnapshot) {
						...
						// The endpoint and passthrough address for proxy1 should be gone.
						require.Empty(t, snap.ConnectProxy.WatchedUpstreamEndpoints[api.String()]["api.default.default.dc1"])
						require.Empty(t, snap.ConnectProxy.PassthroughUpstreams[api.String()]["api.default.default.dc1"])
