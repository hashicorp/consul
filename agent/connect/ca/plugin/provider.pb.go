...
type MinimumLeafTTLResponse struct {
...
func (m *MinimumLeafTTLResponse) Reset()         { *m = MinimumLeafTTLResponse{} }
func (m *MinimumLeafTTLResponse) String() string { return proto.CompactTextString(m) }
func (*MinimumLeafTTLResponse) ProtoMessage()    {}
func (*MinimumLeafTTLResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_94daeb7181770839, []int{12}
}
func (m *MinimumLeafTTLResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MinimumLeafTTLResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MinimumLeafTTLResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (m *MinimumLeafTTLResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MinimumLeafTTLResponse.Merge(m, src)
}
func (m *MinimumLeafTTLResponse) XXX_Size() int {
	return m.Size()
}
func (m *MinimumLeafTTLResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_MinimumLeafTTLResponse.DiscardUnknown(m)
}

var xxx_messageInfo_MinimumLeafTTLResponse proto.InternalMessageInfo

func (m *MinimumLeafTTLResponse) GetTtl() *types.Duration {
	if m != nil {
		return m.Ttl
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*MinimumLeafTTLResponse)(nil), "plugin.MinimumLeafTTLResponse")
...
var fileDescriptor_94daeb7181770839 = []byte{
	...
	,
}
...
type CAClient interface {
	...
	MinimumLeafTTL(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*MinimumLeafTTLResponse, error)
...
func (c *cAClient) MinimumLeafTTL(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*MinimumLeafTTLResponse, error) {
	out := new(MinimumLeafTTLResponse)
	err := c.cc.Invoke(ctx, "/plugin.CA/MinimumLeafTTL", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CAServer interface {
	...
	MinimumLeafTTL(context.Context, *Empty) (*MinimumLeafTTLResponse, error)
...
func _CA_MinimumLeafTTL_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CAServer).MinimumLeafTTL(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/plugin.CA/MinimumLeafTTL",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CAServer).MinimumLeafTTL(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _CA_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "MinimumLeafTTL",
			Handler:    _CA_MinimumLeafTTL_Handler,
		},
		{
			MethodName: "Cleanup",
...
func (m *MinimumLeafTTLResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *MinimumLeafTTLResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.Ttl != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintProvider(dAtA, i, uint64(m.Ttl.Size()))
...
func (m *MinimumLeafTTLResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MinimumLeafTTLResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MinimumLeafTTLResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MinimumLeafTTLResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
