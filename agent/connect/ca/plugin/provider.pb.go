...
type ConfigureRequest struct {
	...
	PrimaryDc            bool     `protobuf:"varint,3,opt,name=primary_dc,json=primaryDc,proto3" json:"primary_dc,omitempty"`
...
func (m *ConfigureRequest) GetDatacenter() string {
	if m != nil {
		return m.Datacenter
	}
	return ""
...
func (m *ConfigureRequest) GetPrimaryDc() bool {
	if m != nil {
		return m.PrimaryDc
	}
	return false
...
var fileDescriptor_c6a9f3c02af3d1c8 = []byte{
	...
	,
}
...
func (m *ConfigureRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Datacenter) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintProvider(dAtA, i, uint64(len(m.Datacenter)))
...
func (m *ConfigureRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field PrimaryDc", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
