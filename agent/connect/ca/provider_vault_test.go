...
func TestVaultCAProvider_SecondaryActiveIntermediate(t *testing.T) {
	...
	provider := createVaultProvider(t, false, testVault.Addr, token, map[string]interface{}{
		"RootPKIPath":         "pki-root/",
		"IntermediatePKIPath": "pki-intermediate/",
	})
...
func TestVaultCAProvider_RenewToken(t *testing.T) {
	...
	_ = createVaultProvider(t, true, testVault.Addr, providerToken, map[string]interface{}{
		"RootPKIPath":         "pki-root/",
		"IntermediatePKIPath": "pki-intermediate/",
	})
...
func TestVaultCAProvider_RenewTokenStopWatcherOnConfigure(t *testing.T) {
	...
	provider := createVaultProvider(t, true, testVault.Addr, providerToken, map[string]interface{}{
		"RootPKIPath":         "pki-root/",
		"IntermediatePKIPath": "pki-intermediate/",
	})
	...
	providerConfig := vaultProviderConfig(t, testVault.Addr, providerToken, map[string]interface{}{
		"RootPKIPath":         "pki-root/",
		"IntermediatePKIPath": "pki-intermediate/",
	})
...
func TestVaultCAProvider_SignLeaf(t *testing.T) {
	...
	run := func(t *testing.T, tc KeyTestCase) {
		...
		provider := createVaultProvider(t, true, testVault.Addr, token, map[string]interface{}{
			"LeafCertTTL":         "1h",
...
func TestVaultCAProvider_CrossSignCA(t *testing.T) {
	...
	run := func(t *testing.T, tc CASigningKeyTypes, withSudo, expectFailure bool) {
		...
		provider1 := createVaultProvider(t, true, testVault1.Addr, token1, map[string]interface{}{
			"LeafCertTTL":         "1h",
		...
		provider2 := createVaultProvider(t, true, testVault2.Addr, token2, map[string]interface{}{
			"LeafCertTTL":         "1h",
...
func TestVaultProvider_SignIntermediate(t *testing.T) {
	...
	run := func(t *testing.T, tc CASigningKeyTypes) {
		...
		provider2 := createVaultProvider(t, false, testVault2.Addr, token2, map[string]interface{}{
			"LeafCertTTL":         "1h",
			"PrivateKeyType":      tc.CSRKeyType,
			"PrivateKeyBits":      tc.CSRKeyBits,
			"RootPKIPath":         "pki-root/",
...
func createVaultProvider(t *testing.T, isPrimary bool, addr, token string, rawConf map[string]interface{}) *VaultProvider {
	t.Helper()
