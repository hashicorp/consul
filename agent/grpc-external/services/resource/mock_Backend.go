...
// WatchList provides a mock function with given fields: ctx, resType, tenancy, namePrefix, includeSnapshotOperations
func (_m *MockBackend) WatchList(ctx context.Context, resType storage.UnversionedType, tenancy *pbresource.Tenancy, namePrefix string, includeSnapshotOperations bool) (storage.Watch, error) {
	ret := _m.Called(ctx, resType, tenancy, namePrefix, includeSnapshotOperations)

	var r0 storage.Watch
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, storage.UnversionedType, *pbresource.Tenancy, string, bool) (storage.Watch, error)); ok {
		return rf(ctx, resType, tenancy, namePrefix, includeSnapshotOperations)
	}
	if rf, ok := ret.Get(0).(func(context.Context, storage.UnversionedType, *pbresource.Tenancy, string, bool) storage.Watch); ok {
		r0 = rf(ctx, resType, tenancy, namePrefix, includeSnapshotOperations)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, storage.UnversionedType, *pbresource.Tenancy, string, bool) error); ok {
		r1 = rf(ctx, resType, tenancy, namePrefix, includeSnapshotOperations)
	} else {
		r1 = ret.Error(1)
	}
