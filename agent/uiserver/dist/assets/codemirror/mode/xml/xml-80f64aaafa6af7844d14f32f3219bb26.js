...
return"<"==r?t.eat("!")?t.eat("[")?t.match("CDATA[")?n(m("atom","]]>")):null:t.match("--")?n(m("comment","--\x3e")):t.match("DOCTYPE",!0,!0)?(t.eatWhile(/[\w\._\-]/),n(g(1))):null:t.eat("?")?(t.eatWhile(/[\w\._\-]/),e.tokenize=m("meta","?>"),"meta"):(a=t.eat("/")?"closeTag":"openTag",e.tokenize=f,"tag bracket"):"&"==r?(t.eat("#")?t.eat("x")?t.eatWhile(/[a-fA-F\d]/)&&t.eat(";"):t.eatWhile(/[\d]/)&&t.eat(";"):t.eatWhile(/[\w\.\-:]/)&&t.eat(";"))?"atom":"error":(t.eatWhile(/[^&<]/),null)}function f(t,e){var n,r,o=t.next()
if(">"==o||"/"==o&&t.eat(">"))return e.tokenize=s,a=">"==o?"endTag":"selfcloseTag","tag bracket"
if("="==o)return a="equals",null
if("<"==o){e.tokenize=s,e.state=b,e.tagName=e.tagStart=null
...
break}return"string"},r.isInAttribute=!0,r),e.stringStartCol=t.column(),e.tokenize(t,e)):(t.match(/^[^\s\u00a0=<>\"\']*[^\s\u00a0=<>\"\'\/]/),"word")}function m(t,e){return function(n,r){for(;!n.eol();){if(n.match(e)){r.tokenize=s
break}n.next()}return t}}function g(t){return function(e,n){for(var r;null!=(r=e.next());){if("<"==r)return n.tokenize=g(t+1),n.tokenize(e,n)
if(">"==r){if(1==t){n.tokenize=s
break}return n.tokenize=g(t-1),n.tokenize(e,n)}}return"meta"}}function p(t,e,n){this.prev=t.context,this.tagName=e,this.indent=t.indented,this.startOfLine=n,(u.doNotIndent.hasOwnProperty(e)||t.context&&t.context.noIndent)&&(this.noIndent=!0)}function h(t){t.context&&(t.context=t.context.prev)}function x(t,e){for(var n;;){if(!t.context)return
if(n=t.context.tagName,!u.contextGrabbers.hasOwnProperty(n)||!u.contextGrabbers[n].hasOwnProperty(e))return
h(t)}}function b(t,e,n){return"openTag"==t?(n.tagStart=e.column(),k):"closeTag"==t?w:b}function k(t,e,n){return"word"==t?(n.tagName=e.current(),i="tag",z):(i="error",k)}function w(t,e,n){if("word"==t){var r=e.current()
return n.context&&n.context.tagName!=r&&u.implicitlyClosed.hasOwnProperty(n.context.tagName)&&h(n),n.context&&n.context.tagName==r||!1===u.matchClosing?(i="tag",v):(i="tag error",y)}return i="error",y}function v(t,e,n){return"endTag"!=t?(i="error",v):(h(n),b)}function y(t,e,n){return i="error",v(t,0,n)}function z(t,e,n){if("word"==t)return i="attribute",N
if("endTag"==t||"selfcloseTag"==t){var r=n.tagName,o=n.tagStart
return n.tagName=n.tagStart=null,"selfcloseTag"==t||u.autoSelfClosers.hasOwnProperty(r)?x(n,r):(x(n,r),n.context=new p(n,r,o==n.indented)),b}return i="error",z}function N(t,e,n){return"equals"==t?T:(u.allowMissing||(i="error"),z(t,0,n))}function T(t,e,n){return"string"==t?C:"word"==t&&u.allowUnquoted?(i="string",z):(i="error",z(t,0,n))}function C(t,e,n){return"string"==t?C:z(t,0,n)}return s.isInText=!0,{startState:function(t){var e={tokenize:s,state:b,indented:t||0,tagName:null,tagStart:null,context:null}
