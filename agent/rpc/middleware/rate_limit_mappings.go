...
var rpcRateLimitSpecs = map[string]rate.OperationType{
	...
	"Operator.AutopilotGetConfiguration": rate.OperationTypeRead,
	"Operator.AutopilotSetConfiguration": rate.OperationTypeWrite,
	"Operator.AutopilotState":            rate.OperationTypeRead,
	"Operator.RaftGetConfiguration":      rate.OperationTypeRead,
	"Operator.RaftRemovePeerByAddress":   rate.OperationTypeWrite,
	"Operator.RaftRemovePeerByID":        rate.OperationTypeWrite,
	"Operator.ServerHealth":              rate.OperationTypeRead,
	...
	"Status.Leader":    rate.OperationTypeRead,
	"Status.Peers":     rate.OperationTypeRead,
	"Status.Ping":      rate.OperationTypeRead,
	"Status.RaftStats": rate.OperationTypeRead,
