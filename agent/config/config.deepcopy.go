...
func (o *RuntimeConfig) DeepCopy() *RuntimeConfig {
	...
	if o.StartJoinAddrsLAN != nil {
		cp.StartJoinAddrsLAN = make([]string, len(o.StartJoinAddrsLAN))
		copy(cp.StartJoinAddrsLAN, o.StartJoinAddrsLAN)
	}
	if o.StartJoinAddrsWAN != nil {
		cp.StartJoinAddrsWAN = make([]string, len(o.StartJoinAddrsWAN))
		copy(cp.StartJoinAddrsWAN, o.StartJoinAddrsWAN)
	}
