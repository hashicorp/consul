...
var rpcRateLimitSpecs = map[string]rate.OperationSpec{
	...
	"/hashicorp.consul.internal.configentry.ConfigEntryService/GetResolvedImportedServices": {Type: rate.OperationTypeRead, Category: rate.OperationCategoryConfigEntry},
