...
var rpcRateLimitSpecs = map[string]rate.OperationSpec{
	...
	"/hashicorp.consul.internal.storage.raft.Forwarding/Delete":                  {Type: rate.OperationTypeExempt, Category: rate.OperationCategoryResource},
	"/hashicorp.consul.internal.storage.raft.Forwarding/List":                    {Type: rate.OperationTypeExempt, Category: rate.OperationCategoryResource},
	"/hashicorp.consul.internal.storage.raft.Forwarding/Read":                    {Type: rate.OperationTypeExempt, Category: rate.OperationCategoryResource},
	"/hashicorp.consul.internal.storage.raft.Forwarding/Write":                   {Type: rate.OperationTypeExempt, Category: rate.OperationCategoryResource},
