...
var rpcRateLimitSpecs = map[string]rate.OperationSpec{
	...
	"/hashicorp.consul.resource.v1.ResourceService/Delete":                                  {Type: rate.OperationTypeWrite, Category: rate.OperationCategoryResource},
	"/hashicorp.consul.resource.v1.ResourceService/List":                                    {Type: rate.OperationTypeRead, Category: rate.OperationCategoryResource},
	"/hashicorp.consul.resource.v1.ResourceService/ListByOwner":                             {Type: rate.OperationTypeRead, Category: rate.OperationCategoryResource},
	"/hashicorp.consul.resource.v1.ResourceService/MutateAndValidate":                       {Type: rate.OperationTypeRead, Category: rate.OperationCategoryResource},
	"/hashicorp.consul.resource.v1.ResourceService/Read":                                    {Type: rate.OperationTypeRead, Category: rate.OperationCategoryResource},
	"/hashicorp.consul.resource.v1.ResourceService/WatchList":                               {Type: rate.OperationTypeRead, Category: rate.OperationCategoryResource},
	"/hashicorp.consul.resource.v1.ResourceService/Write":                                   {Type: rate.OperationTypeWrite, Category: rate.OperationCategoryResource},
	"/hashicorp.consul.resource.v1.ResourceService/WriteStatus":                             {Type: rate.OperationTypeWrite, Category: rate.OperationCategoryResource},
