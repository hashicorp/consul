...
var file_agent_grpc_middleware_testutil_testservice_simple_proto_goTypes = []any{
...
func file_agent_grpc_middleware_testutil_testservice_simple_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_agent_grpc_middleware_testutil_testservice_simple_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Req); i {
			case 0:
				return &v.state
			case 1:
		...
		file_agent_grpc_middleware_testutil_testservice_simple_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Resp); i {
			case 0:
				return &v.state
			case 1:
