...
// DeepCopy generates a deep copy of *APIGatewayConfigEntry
func (o *APIGatewayConfigEntry) DeepCopy() *APIGatewayConfigEntry {
	var cp APIGatewayConfigEntry = *o
	if o.Listeners != nil {
		cp.Listeners = make([]APIGatewayListener, len(o.Listeners))
		copy(cp.Listeners, o.Listeners)
		for i2 := range o.Listeners {
			{
				retV := o.Listeners[i2].DeepCopy()
...
// DeepCopy generates a deep copy of *JWTProviderConfigEntry
func (o *JWTProviderConfigEntry) DeepCopy() *JWTProviderConfigEntry {
	var cp JWTProviderConfigEntry = *o
	if o.JSONWebKeySet != nil {
		cp.JSONWebKeySet = new(JSONWebKeySet)
		*cp.JSONWebKeySet = *o.JSONWebKeySet
		if o.JSONWebKeySet.Local != nil {
			cp.JSONWebKeySet.Local = new(LocalJWKS)
			*cp.JSONWebKeySet.Local = *o.JSONWebKeySet.Local
		}
		if o.JSONWebKeySet.Remote != nil {
			cp.JSONWebKeySet.Remote = new(RemoteJWKS)
			*cp.JSONWebKeySet.Remote = *o.JSONWebKeySet.Remote
			if o.JSONWebKeySet.Remote.RetryPolicy != nil {
				cp.JSONWebKeySet.Remote.RetryPolicy = new(JWKSRetryPolicy)
				*cp.JSONWebKeySet.Remote.RetryPolicy = *o.JSONWebKeySet.Remote.RetryPolicy
				if o.JSONWebKeySet.Remote.RetryPolicy.RetryPolicyBackOff != nil {
					cp.JSONWebKeySet.Remote.RetryPolicy.RetryPolicyBackOff = new(RetryPolicyBackOff)
					*cp.JSONWebKeySet.Remote.RetryPolicy.RetryPolicyBackOff = *o.JSONWebKeySet.Remote.RetryPolicy.RetryPolicyBackOff
				}
			}
			if o.JSONWebKeySet.Remote.JWKSCluster != nil {
				cp.JSONWebKeySet.Remote.JWKSCluster = new(JWKSCluster)
				*cp.JSONWebKeySet.Remote.JWKSCluster = *o.JSONWebKeySet.Remote.JWKSCluster
				if o.JSONWebKeySet.Remote.JWKSCluster.TLSCertificates != nil {
					cp.JSONWebKeySet.Remote.JWKSCluster.TLSCertificates = new(JWKSTLSCertificate)
					*cp.JSONWebKeySet.Remote.JWKSCluster.TLSCertificates = *o.JSONWebKeySet.Remote.JWKSCluster.TLSCertificates
					if o.JSONWebKeySet.Remote.JWKSCluster.TLSCertificates.CaCertificateProviderInstance != nil {
						cp.JSONWebKeySet.Remote.JWKSCluster.TLSCertificates.CaCertificateProviderInstance = new(JWKSTLSCertProviderInstance)
						*cp.JSONWebKeySet.Remote.JWKSCluster.TLSCertificates.CaCertificateProviderInstance = *o.JSONWebKeySet.Remote.JWKSCluster.TLSCertificates.CaCertificateProviderInstance
					}
					if o.JSONWebKeySet.Remote.JWKSCluster.TLSCertificates.TrustedCA != nil {
						cp.JSONWebKeySet.Remote.JWKSCluster.TLSCertificates.TrustedCA = new(JWKSTLSCertTrustedCA)
						*cp.JSONWebKeySet.Remote.JWKSCluster.TLSCertificates.TrustedCA = *o.JSONWebKeySet.Remote.JWKSCluster.TLSCertificates.TrustedCA
						if o.JSONWebKeySet.Remote.JWKSCluster.TLSCertificates.TrustedCA.InlineBytes != nil {
							cp.JSONWebKeySet.Remote.JWKSCluster.TLSCertificates.TrustedCA.InlineBytes = make([]byte, len(o.JSONWebKeySet.Remote.JWKSCluster.TLSCertificates.TrustedCA.InlineBytes))
							copy(cp.JSONWebKeySet.Remote.JWKSCluster.TLSCertificates.TrustedCA.InlineBytes, o.JSONWebKeySet.Remote.JWKSCluster.TLSCertificates.TrustedCA.InlineBytes)
						}
					}
				}
			}
	...
	if o.Audiences != nil {
		cp.Audiences = make([]string, len(o.Audiences))
		copy(cp.Audiences, o.Audiences)
	}
	if o.Locations != nil {
		cp.Locations = make([]*JWTLocation, len(o.Locations))
		copy(cp.Locations, o.Locations)
		for i2 := range o.Locations {
			if o.Locations[i2] != nil {
				cp.Locations[i2] = new(JWTLocation)
				*cp.Locations[i2] = *o.Locations[i2]
				if o.Locations[i2].Header != nil {
					cp.Locations[i2].Header = new(JWTLocationHeader)
					*cp.Locations[i2].Header = *o.Locations[i2].Header
				}
				if o.Locations[i2].QueryParam != nil {
					cp.Locations[i2].QueryParam = new(JWTLocationQueryParam)
					*cp.Locations[i2].QueryParam = *o.Locations[i2].QueryParam
				}
				if o.Locations[i2].Cookie != nil {
					cp.Locations[i2].Cookie = new(JWTLocationCookie)
					*cp.Locations[i2].Cookie = *o.Locations[i2].Cookie
				}
			}
		}
	}
	if o.Forwarding != nil {
		cp.Forwarding = new(JWTForwardingConfig)
		*cp.Forwarding = *o.Forwarding
	}
	if o.CacheConfig != nil {
		cp.CacheConfig = new(JWTCacheConfig)
		*cp.CacheConfig = *o.CacheConfig
	}
	if o.Meta != nil {
		cp.Meta = make(map[string]string, len(o.Meta))
		for k2, v2 := range o.Meta {
