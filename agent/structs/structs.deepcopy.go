...
// DeepCopy generates a deep copy of *GatewayCredentialInjection
func (o *GatewayCredentialInjection) DeepCopy() *GatewayCredentialInjection {
	var cp GatewayCredentialInjection = *o
	return &cp
}
...
func (o *GatewayService) DeepCopy() *GatewayService {
	...
	if o.CredentialInjection != nil {
		cp.CredentialInjection = o.CredentialInjection.DeepCopy()
	}
	if o.Credential != nil {
		cp.Credential = o.Credential.DeepCopy()
	}
	return &cp
}

// DeepCopy generates a deep copy of *GatewayServiceCredential
func (o *GatewayServiceCredential) DeepCopy() *GatewayServiceCredential {
	var cp GatewayServiceCredential = *o
	return &cp
}
				...
				for i5 := range o.Rules[i2].Filters.ExtProc {
					if o.Rules[i2].Filters.ExtProc[i5].Overrides != nil {
						...
						*cp.Rules[i2].Filters.ExtProc[i5].Overrides = *o.Rules[i2].Filters.ExtProc[i5].Overrides
						...
						if o.Rules[i2].Filters.ExtProc[i5].Overrides.GRPCInitialMetadata != nil {
							cp.Rules[i2].Filters.ExtProc[i5].Overrides.GRPCInitialMetadata = make([]ExtProcMetadataKV, len(o.Rules[i2].Filters.ExtProc[i5].Overrides.GRPCInitialMetadata))
							copy(cp.Rules[i2].Filters.ExtProc[i5].Overrides.GRPCInitialMetadata, o.Rules[i2].Filters.ExtProc[i5].Overrides.GRPCInitialMetadata)
						}
					}
				}
			}
						...
						for i7 := range o.Rules[i2].Services[i4].Filters.ExtProc {
							if o.Rules[i2].Services[i4].Filters.ExtProc[i7].Overrides != nil {
								...
								*cp.Rules[i2].Services[i4].Filters.ExtProc[i7].Overrides = *o.Rules[i2].Services[i4].Filters.ExtProc[i7].Overrides
								...
								if o.Rules[i2].Services[i4].Filters.ExtProc[i7].Overrides.GRPCInitialMetadata != nil {
									cp.Rules[i2].Services[i4].Filters.ExtProc[i7].Overrides.GRPCInitialMetadata = make([]ExtProcMetadataKV, len(o.Rules[i2].Services[i4].Filters.ExtProc[i7].Overrides.GRPCInitialMetadata))
									copy(cp.Rules[i2].Services[i4].Filters.ExtProc[i7].Overrides.GRPCInitialMetadata, o.Rules[i2].Services[i4].Filters.ExtProc[i7].Overrides.GRPCInitialMetadata)
								}
							}
						}
					}
