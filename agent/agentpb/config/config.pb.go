...
type Config struct {
	...
	AutoEncrypt       *AutoEncrypt `protobuf:"bytes,5,opt,name=AutoEncrypt,proto3" json:"AutoEncrypt,omitempty"`
	// Gossip Configurations
	EncryptKey            string   `protobuf:"bytes,6,opt,name=EncryptKey,proto3" json:"EncryptKey,omitempty"`
	EncryptVerifyIncoming bool     `protobuf:"varint,7,opt,name=EncryptVerifyIncoming,proto3" json:"EncryptVerifyIncoming,omitempty"`
	EncryptVerifyOutgoing bool     `protobuf:"varint,8,opt,name=EncryptVerifyOutgoing,proto3" json:"EncryptVerifyOutgoing,omitempty"`
	RetryJoinLAN          []string `protobuf:"bytes,9,rep,name=RetryJoinLAN,proto3" json:"RetryJoinLAN,omitempty"`
	SegmentName           string   `protobuf:"bytes,10,opt,name=SegmentName,proto3" json:"SegmentName,omitempty"`
	// TLS Configurations
	VerifyOutgoing              bool     `protobuf:"varint,11,opt,name=VerifyOutgoing,proto3" json:"VerifyOutgoing,omitempty"`
	VerifyServerHostname        bool     `protobuf:"varint,12,opt,name=VerifyServerHostname,proto3" json:"VerifyServerHostname,omitempty"`
	TLSCipherSuites             string   `protobuf:"bytes,13,opt,name=TLSCipherSuites,proto3" json:"TLSCipherSuites,omitempty"`
	TLSMinVersion               string   `protobuf:"bytes,14,opt,name=TLSMinVersion,proto3" json:"TLSMinVersion,omitempty"`
	TLSPreferServerCipherSuites bool     `protobuf:"varint,15,opt,name=TLSPreferServerCipherSuites,proto3" json:"TLSPreferServerCipherSuites,omitempty"`
...
func (m *Config) GetEncryptKey() string {
	if m != nil {
		return m.EncryptKey
	}
	return ""
...
func (m *Config) GetEncryptVerifyIncoming() bool {
	if m != nil {
		return m.EncryptVerifyIncoming
	}
	return false
}

func (m *Config) GetEncryptVerifyOutgoing() bool {
	if m != nil {
		return m.EncryptVerifyOutgoing
	}
	return false
}

func (m *Config) GetRetryJoinLAN() []string {
	if m != nil {
...
func (m *Config) GetVerifyOutgoing() bool {
	if m != nil {
...
func (m *Config) GetVerifyServerHostname() bool {
	if m != nil {
...
func (m *Config) GetTLSCipherSuites() string {
	if m != nil {
...
func (m *Config) GetTLSMinVersion() string {
	if m != nil {
...
func (m *Config) GetTLSPreferServerCipherSuites() bool {
	if m != nil {
		return m.TLSPreferServerCipherSuites
	}
	return false
}
...
var fileDescriptor_32691daf3e11879d = []byte{
	...
	,
}
...
func (m *Config) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.EncryptKey) > 0 {
		dAtA[i] = 0x32
		i++
		i = encodeVarintConfig(dAtA, i, uint64(len(m.EncryptKey)))
		i += copy(dAtA[i:], m.EncryptKey)
	}
	if m.EncryptVerifyIncoming {
		dAtA[i] = 0x38
		i++
		if m.EncryptVerifyIncoming {
			dAtA[i] = 1
	...
	if len(m.TLSCipherSuites) > 0 {
		dAtA[i] = 0x6a
		i++
		i = encodeVarintConfig(dAtA, i, uint64(len(m.TLSCipherSuites)))
		i += copy(dAtA[i:], m.TLSCipherSuites)
	}
	if len(m.TLSMinVersion) > 0 {
		dAtA[i] = 0x72
		i++
		i = encodeVarintConfig(dAtA, i, uint64(len(m.TLSMinVersion)))
		i += copy(dAtA[i:], m.TLSMinVersion)
	}
	if m.TLSPreferServerCipherSuites {
		dAtA[i] = 0x78
		i++
		if m.TLSPreferServerCipherSuites {
			dAtA[i] = 1
...
func (m *ACL) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Tokens != nil {
		...
		n3, err := m.Tokens.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n3
...
func (m *Config) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field EncryptVerifyIncoming", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.EncryptVerifyIncoming = bool(v != 0)
		case 8:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field EncryptVerifyOutgoing", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.EncryptVerifyOutgoing = bool(v != 0)
		case 9:
			if wireType != 2 {
		...
		case 13:
			...
			m.TLSCipherSuites = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 14:
			if wireType != 2 {
		...
		case 15:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TLSPreferServerCipherSuites", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TLSPreferServerCipherSuites = bool(v != 0)
		default:
			iNdEx = preIndex
