...
func (s *Server) injectHTTPFilterOnFilterChains(
	...
	for chainIdx, chain := range listener.FilterChains {
		...
		case *envoy_listener_v3.Filter_TypedConfig:
...
func makeTLSInspectorListenerFilter() (*envoy_listener_v3.ListenerFilter, error) {
	return &envoy_listener_v3.ListenerFilter{Name: wellknown.TlsInspector}, nil
}
...
func makeFilter(name string, cfg proto.Message, typed bool) (*envoy_listener_v3.Filter, error) {
...
func makeEnvoyHTTPFilter(name string, cfg proto.Message, typed bool) (*envoy_http_v3.HttpFilter, error) {
	...
	filter.ConfigType = &envoy_http_v3.HttpFilter_TypedConfig{TypedConfig: any}
