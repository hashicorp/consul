...
func init() {
	...
	registerEndpoint("/v1/acl/policy/translate", []string{"POST"}, (*HTTPServer).ACLPolicyTranslate)
	...
	registerEndpoint("/v1/acl/token/upgrade/", []string{"PUT"}, (*HTTPServer).ACLTokenUpgrade)
