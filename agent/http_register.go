...
func init() {
	...
	registerEndpoint("/v1/agent/metrics/certificates", []string{"GET"}, (*HTTPHandlers).AgentMetricsCertificates)
	...
	registerEndpoint("/v1/operator/utilization", []string{"GET"}, (*HTTPHandlers).OperatorUtilizationEndpoint)
