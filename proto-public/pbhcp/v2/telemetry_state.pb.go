...
var file_pbhcp_v2_telemetry_state_proto_goTypes = []any{
...
func file_pbhcp_v2_telemetry_state_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_pbhcp_v2_telemetry_state_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_pbhcp_v2_telemetry_state_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_pbhcp_v2_telemetry_state_proto_msgTypes[2].Exporter = func(v any, i int) any {
