...
var file_proto_public_annotations_ratelimit_ratelimit_proto_goTypes = []any{
...
func file_proto_public_annotations_ratelimit_ratelimit_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_public_annotations_ratelimit_ratelimit_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Spec); i {
			case 0:
				return &v.state
			case 1:
