...
func (x *StaticEndpointGroupConfig) Reset() {
	*x = StaticEndpointGroupConfig{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pbmesh_v1alpha1_pbproxystate_cluster_proto_msgTypes[25]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*StaticEndpointGroupConfig) Descriptor() ([]byte, []int) {
	return file_pbmesh_v1alpha1_pbproxystate_cluster_proto_rawDescGZIP(), []int{25}
}
...
var file_pbmesh_v1alpha1_pbproxystate_cluster_proto_msgTypes = make([]protoimpl.MessageInfo, 26)
var file_pbmesh_v1alpha1_pbproxystate_cluster_proto_goTypes = []interface{}{
	...
	(*DestinationCluster)(nil),             // 9: hashicorp.consul.mesh.v1alpha1.pbproxystate.DestinationCluster
	(*L4WeightedClusterGroup)(nil),         // 10: hashicorp.consul.mesh.v1alpha1.pbproxystate.L4WeightedClusterGroup
	(*L7WeightedClusterGroup)(nil),         // 11: hashicorp.consul.mesh.v1alpha1.pbproxystate.L7WeightedClusterGroup
	(*L4WeightedDestinationCluster)(nil),   // 12: hashicorp.consul.mesh.v1alpha1.pbproxystate.L4WeightedDestinationCluster
	(*L7WeightedDestinationCluster)(nil),   // 13: hashicorp.consul.mesh.v1alpha1.pbproxystate.L7WeightedDestinationCluster
	(*DynamicEndpointGroupConfig)(nil),     // 14: hashicorp.consul.mesh.v1alpha1.pbproxystate.DynamicEndpointGroupConfig
	(*LBPolicyLeastRequest)(nil),           // 15: hashicorp.consul.mesh.v1alpha1.pbproxystate.LBPolicyLeastRequest
	(*LBPolicyRoundRobin)(nil),             // 16: hashicorp.consul.mesh.v1alpha1.pbproxystate.LBPolicyRoundRobin
	(*LBPolicyRandom)(nil),                 // 17: hashicorp.consul.mesh.v1alpha1.pbproxystate.LBPolicyRandom
	(*LBPolicyRingHash)(nil),               // 18: hashicorp.consul.mesh.v1alpha1.pbproxystate.LBPolicyRingHash
	(*LBPolicyMaglev)(nil),                 // 19: hashicorp.consul.mesh.v1alpha1.pbproxystate.LBPolicyMaglev
	(*CircuitBreakers)(nil),                // 20: hashicorp.consul.mesh.v1alpha1.pbproxystate.CircuitBreakers
	(*UpstreamLimits)(nil),                 // 21: hashicorp.consul.mesh.v1alpha1.pbproxystate.UpstreamLimits
	(*OutlierDetection)(nil),               // 22: hashicorp.consul.mesh.v1alpha1.pbproxystate.OutlierDetection
	(*UpstreamConnectionOptions)(nil),      // 23: hashicorp.consul.mesh.v1alpha1.pbproxystate.UpstreamConnectionOptions
	(*PassthroughEndpointGroupConfig)(nil), // 24: hashicorp.consul.mesh.v1alpha1.pbproxystate.PassthroughEndpointGroupConfig
	(*DNSEndpointGroupConfig)(nil),         // 25: hashicorp.consul.mesh.v1alpha1.pbproxystate.DNSEndpointGroupConfig
	(*StaticEndpointGroupConfig)(nil),      // 26: hashicorp.consul.mesh.v1alpha1.pbproxystate.StaticEndpointGroupConfig
	(*durationpb.Duration)(nil),            // 27: google.protobuf.Duration
	(*TransportSocket)(nil),                // 28: hashicorp.consul.mesh.v1alpha1.pbproxystate.TransportSocket
	(*wrapperspb.UInt32Value)(nil),         // 29: google.protobuf.UInt32Value
	(*HeaderMutation)(nil),                 // 30: hashicorp.consul.mesh.v1alpha1.pbproxystate.HeaderMutation
...
var file_pbmesh_v1alpha1_pbproxystate_cluster_proto_depIdxs = []int32{
	...
	27, // 4: hashicorp.consul.mesh.v1alpha1.pbproxystate.FailoverGroupConfig.connect_timeout:type_name -> google.protobuf.Duration
	...
	14, // 9: hashicorp.consul.mesh.v1alpha1.pbproxystate.DynamicEndpointGroup.config:type_name -> hashicorp.consul.mesh.v1alpha1.pbproxystate.DynamicEndpointGroupConfig
	28, // 10: hashicorp.consul.mesh.v1alpha1.pbproxystate.DynamicEndpointGroup.outbound_tls:type_name -> hashicorp.consul.mesh.v1alpha1.pbproxystate.TransportSocket
	24, // 11: hashicorp.consul.mesh.v1alpha1.pbproxystate.PassthroughEndpointGroup.config:type_name -> hashicorp.consul.mesh.v1alpha1.pbproxystate.PassthroughEndpointGroupConfig
	28, // 12: hashicorp.consul.mesh.v1alpha1.pbproxystate.PassthroughEndpointGroup.outbound_tls:type_name -> hashicorp.consul.mesh.v1alpha1.pbproxystate.TransportSocket
	25, // 13: hashicorp.consul.mesh.v1alpha1.pbproxystate.DNSEndpointGroup.config:type_name -> hashicorp.consul.mesh.v1alpha1.pbproxystate.DNSEndpointGroupConfig
	28, // 14: hashicorp.consul.mesh.v1alpha1.pbproxystate.DNSEndpointGroup.outbound_tls:type_name -> hashicorp.consul.mesh.v1alpha1.pbproxystate.TransportSocket
	...
	13, // 17: hashicorp.consul.mesh.v1alpha1.pbproxystate.L7WeightedClusterGroup.clusters:type_name -> hashicorp.consul.mesh.v1alpha1.pbproxystate.L7WeightedDestinationCluster
	29, // 18: hashicorp.consul.mesh.v1alpha1.pbproxystate.L4WeightedDestinationCluster.weight:type_name -> google.protobuf.UInt32Value
	29, // 19: hashicorp.consul.mesh.v1alpha1.pbproxystate.L7WeightedDestinationCluster.weight:type_name -> google.protobuf.UInt32Value
	30, // 20: hashicorp.consul.mesh.v1alpha1.pbproxystate.L7WeightedDestinationCluster.header_mutations:type_name -> hashicorp.consul.mesh.v1alpha1.pbproxystate.HeaderMutation
	27, // 21: hashicorp.consul.mesh.v1alpha1.pbproxystate.DynamicEndpointGroupConfig.connect_timeout:type_name -> google.protobuf.Duration
	15, // 22: hashicorp.consul.mesh.v1alpha1.pbproxystate.DynamicEndpointGroupConfig.least_request:type_name -> hashicorp.consul.mesh.v1alpha1.pbproxystate.LBPolicyLeastRequest
	16, // 23: hashicorp.consul.mesh.v1alpha1.pbproxystate.DynamicEndpointGroupConfig.round_robin:type_name -> hashicorp.consul.mesh.v1alpha1.pbproxystate.LBPolicyRoundRobin
	17, // 24: hashicorp.consul.mesh.v1alpha1.pbproxystate.DynamicEndpointGroupConfig.random:type_name -> hashicorp.consul.mesh.v1alpha1.pbproxystate.LBPolicyRandom
	18, // 25: hashicorp.consul.mesh.v1alpha1.pbproxystate.DynamicEndpointGroupConfig.ring_hash:type_name -> hashicorp.consul.mesh.v1alpha1.pbproxystate.LBPolicyRingHash
	19, // 26: hashicorp.consul.mesh.v1alpha1.pbproxystate.DynamicEndpointGroupConfig.maglev:type_name -> hashicorp.consul.mesh.v1alpha1.pbproxystate.LBPolicyMaglev
	20, // 27: hashicorp.consul.mesh.v1alpha1.pbproxystate.DynamicEndpointGroupConfig.circuit_breakers:type_name -> hashicorp.consul.mesh.v1alpha1.pbproxystate.CircuitBreakers
	22, // 28: hashicorp.consul.mesh.v1alpha1.pbproxystate.DynamicEndpointGroupConfig.outlier_detection:type_name -> hashicorp.consul.mesh.v1alpha1.pbproxystate.OutlierDetection
	23, // 29: hashicorp.consul.mesh.v1alpha1.pbproxystate.DynamicEndpointGroupConfig.upstream_connection_options:type_name -> hashicorp.consul.mesh.v1alpha1.pbproxystate.UpstreamConnectionOptions
	29, // 30: hashicorp.consul.mesh.v1alpha1.pbproxystate.LBPolicyLeastRequest.choice_count:type_name -> google.protobuf.UInt32Value
	31, // 31: hashicorp.consul.mesh.v1alpha1.pbproxystate.LBPolicyRingHash.minimum_ring_size:type_name -> google.protobuf.UInt64Value
	...
	21, // 33: hashicorp.consul.mesh.v1alpha1.pbproxystate.CircuitBreakers.upstream_limits:type_name -> hashicorp.consul.mesh.v1alpha1.pbproxystate.UpstreamLimits
	29, // 34: hashicorp.consul.mesh.v1alpha1.pbproxystate.UpstreamLimits.max_connections:type_name -> google.protobuf.UInt32Value
	29, // 35: hashicorp.consul.mesh.v1alpha1.pbproxystate.UpstreamLimits.max_pending_requests:type_name -> google.protobuf.UInt32Value
	29, // 36: hashicorp.consul.mesh.v1alpha1.pbproxystate.UpstreamLimits.max_concurrent_requests:type_name -> google.protobuf.UInt32Value
	27, // 37: hashicorp.consul.mesh.v1alpha1.pbproxystate.OutlierDetection.interval:type_name -> google.protobuf.Duration
	29, // 38: hashicorp.consul.mesh.v1alpha1.pbproxystate.OutlierDetection.consecutive_5xx:type_name -> google.protobuf.UInt32Value
	29, // 39: hashicorp.consul.mesh.v1alpha1.pbproxystate.OutlierDetection.enforcing_consecutive_5xx:type_name -> google.protobuf.UInt32Value
	29, // 40: hashicorp.consul.mesh.v1alpha1.pbproxystate.OutlierDetection.max_ejection_percent:type_name -> google.protobuf.UInt32Value
	27, // 41: hashicorp.consul.mesh.v1alpha1.pbproxystate.OutlierDetection.base_ejection_time:type_name -> google.protobuf.Duration
	29, // 42: hashicorp.consul.mesh.v1alpha1.pbproxystate.UpstreamConnectionOptions.tcp_keepalive_time:type_name -> google.protobuf.UInt32Value
	29, // 43: hashicorp.consul.mesh.v1alpha1.pbproxystate.UpstreamConnectionOptions.tcp_keepalive_interval:type_name -> google.protobuf.UInt32Value
	29, // 44: hashicorp.consul.mesh.v1alpha1.pbproxystate.UpstreamConnectionOptions.tcp_keepalive_probes:type_name -> google.protobuf.UInt32Value
	27, // 45: hashicorp.consul.mesh.v1alpha1.pbproxystate.PassthroughEndpointGroupConfig.connect_timeout:type_name -> google.protobuf.Duration
	27, // 46: hashicorp.consul.mesh.v1alpha1.pbproxystate.DNSEndpointGroupConfig.connect_timeout:type_name -> google.protobuf.Duration
	...
	20, // 48: hashicorp.consul.mesh.v1alpha1.pbproxystate.DNSEndpointGroupConfig.circuit_breakers:type_name -> hashicorp.consul.mesh.v1alpha1.pbproxystate.CircuitBreakers
	22, // 49: hashicorp.consul.mesh.v1alpha1.pbproxystate.DNSEndpointGroupConfig.outlier_detection:type_name -> hashicorp.consul.mesh.v1alpha1.pbproxystate.OutlierDetection
	23, // 50: hashicorp.consul.mesh.v1alpha1.pbproxystate.DNSEndpointGroupConfig.upstream_connection_options:type_name -> hashicorp.consul.mesh.v1alpha1.pbproxystate.UpstreamConnectionOptions
	27, // 51: hashicorp.consul.mesh.v1alpha1.pbproxystate.StaticEndpointGroupConfig.connect_timeout:type_name -> google.protobuf.Duration
	20, // 52: hashicorp.consul.mesh.v1alpha1.pbproxystate.StaticEndpointGroupConfig.circuit_breakers:type_name -> hashicorp.consul.mesh.v1alpha1.pbproxystate.CircuitBreakers
...
func file_pbmesh_v1alpha1_pbproxystate_cluster_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pbmesh_v1alpha1_pbproxystate_cluster_proto_msgTypes[25].Exporter = func(v interface{}, i int) interface{} {
	...
	file_pbmesh_v1alpha1_pbproxystate_cluster_proto_msgTypes[13].OneofWrappers = []interface{}{
