...
var file_pbmesh_v2beta1_api_gateway_proto_goTypes = []any{
...
func file_pbmesh_v2beta1_api_gateway_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_pbmesh_v2beta1_api_gateway_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_pbmesh_v2beta1_api_gateway_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_pbmesh_v2beta1_api_gateway_proto_msgTypes[2].Exporter = func(v any, i int) any {
	...
	file_pbmesh_v2beta1_api_gateway_proto_msgTypes[2].OneofWrappers = []any{}
	type x struct{}
