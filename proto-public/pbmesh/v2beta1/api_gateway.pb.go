...
// InlineCertificate specifies a certificate written directly into Consul's
// store.
type InlineCertificate struct {
	...
	// PublicKey is the public key component of a certificate.
	PublicKey string `protobuf:"bytes,1,opt,name=PublicKey,proto3" json:"PublicKey,omitempty"`
	// PrivateKey is the private key component of a certificate.
...
func (x *InlineCertificate) Reset() {
	*x = InlineCertificate{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pbmesh_v2beta1_api_gateway_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*InlineCertificate) Descriptor() ([]byte, []int) {
	return file_pbmesh_v2beta1_api_gateway_proto_rawDescGZIP(), []int{3}
}

func (x *InlineCertificate) GetPublicKey() string {
	if x != nil {
		return x.PublicKey
	}
	return ""
...
var file_pbmesh_v2beta1_api_gateway_proto_rawDesc = []byte{
	...
	0x5f, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x73, 0x22, 0x59, 0x0a, 0x11, 0x49,
	...
	0x01, 0x28, 0x09, 0x52, 0x09, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x4b, 0x65, 0x79, 0x12, 0x1e,
	0x0a, 0x0a, 0x50, 0x72, 0x69, 0x76, 0x61, 0x74, 0x65, 0x4b, 0x65, 0x79, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x0a, 0x50, 0x72, 0x69, 0x76, 0x61, 0x74, 0x65, 0x4b, 0x65, 0x79, 0x3a, 0x06,
	0xa2, 0x93, 0x04, 0x02, 0x08, 0x03, 0x42, 0x90, 0x02, 0x0a, 0x21, 0x63, 0x6f, 0x6d, 0x2e, 0x68,
	0x61, 0x73, 0x68, 0x69, 0x63, 0x6f, 0x72, 0x70, 0x2e, 0x63, 0x6f, 0x6e, 0x73, 0x75, 0x6c, 0x2e,
	0x6d, 0x65, 0x73, 0x68, 0x2e, 0x76, 0x32, 0x62, 0x65, 0x74, 0x61, 0x31, 0x42, 0x0f, 0x41, 0x70,
...
var file_pbmesh_v2beta1_api_gateway_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_pbmesh_v2beta1_api_gateway_proto_goTypes = []interface{}{
	...
	(*InlineCertificate)(nil),          // 3: hashicorp.consul.mesh.v2beta1.InlineCertificate
	(*pbresource.Reference)(nil),       // 4: hashicorp.consul.resource.Reference
	(*pbproxystate.TLSParameters)(nil), // 5: hashicorp.consul.mesh.v2beta1.pbproxystate.TLSParameters
}
var file_pbmesh_v2beta1_api_gateway_proto_depIdxs = []int32{
	...
	4, // 2: hashicorp.consul.mesh.v2beta1.APIGatewayTLSConfiguration.certificates:type_name -> hashicorp.consul.resource.Reference
	5, // 3: hashicorp.consul.mesh.v2beta1.APIGatewayTLSConfiguration.tls_parameters:type_name -> hashicorp.consul.mesh.v2beta1.pbproxystate.TLSParameters
...
func file_pbmesh_v2beta1_api_gateway_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pbmesh_v2beta1_api_gateway_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
