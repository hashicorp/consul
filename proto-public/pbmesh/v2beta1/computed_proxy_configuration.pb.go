...
var file_pbmesh_v2beta1_computed_proxy_configuration_proto_goTypes = []any{
...
func file_pbmesh_v2beta1_computed_proxy_configuration_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_pbmesh_v2beta1_computed_proxy_configuration_proto_msgTypes[0].Exporter = func(v any, i int) any {
