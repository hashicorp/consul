...
// DeepCopyInto supports using InlineCertificate within kubernetes types, where deepcopy-gen is used.
func (in *InlineCertificate) DeepCopyInto(out *InlineCertificate) {
	proto.Reset(out)
	proto.Merge(out, proto.Clone(in))
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new InlineCertificate. Required by controller-gen.
func (in *InlineCertificate) DeepCopy() *InlineCertificate {
	if in == nil {
		return nil
	}
	out := new(InlineCertificate)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new InlineCertificate. Required by controller-gen.
func (in *InlineCertificate) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
