...
func (x *DestinationCluster) Reset() {
	*x = DestinationCluster{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pbmesh_v2beta1_pbproxystate_route_proto_msgTypes[16]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DestinationCluster) Descriptor() ([]byte, []int) {
	return file_pbmesh_v2beta1_pbproxystate_route_proto_rawDescGZIP(), []int{16}
}
...
var file_pbmesh_v2beta1_pbproxystate_route_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x08, 0x52, 0x08, 0x74, 0x65, 0x72, 0x6d, 0x69, 0x6e, 0x61, 0x6c, 0x22, 0x28, 0x0a,
	...
	0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x42, 0xd0, 0x02, 0x0a, 0x2e, 0x63, 0x6f, 0x6d, 0x2e,
	0x68, 0x61, 0x73, 0x68, 0x69, 0x63, 0x6f, 0x72, 0x70, 0x2e, 0x63, 0x6f, 0x6e, 0x73, 0x75, 0x6c,
	0x2e, 0x6d, 0x65, 0x73, 0x68, 0x2e, 0x76, 0x32, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x70, 0x62,
	0x70, 0x72, 0x6f, 0x78, 0x79, 0x73, 0x74, 0x61, 0x74, 0x65, 0x42, 0x0a, 0x52, 0x6f, 0x75, 0x74,
...
var file_pbmesh_v2beta1_pbproxystate_route_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
var file_pbmesh_v2beta1_pbproxystate_route_proto_goTypes = []interface{}{
	...
	(*HeaderMutation)(nil),             // 17: hashicorp.consul.mesh.v2beta1.pbproxystate.HeaderMutation
...
var file_pbmesh_v2beta1_pbproxystate_route_proto_depIdxs = []int32{
	...
	17, // 1: hashicorp.consul.mesh.v2beta1.pbproxystate.VirtualHost.header_mutations:type_name -> hashicorp.consul.mesh.v2beta1.pbproxystate.HeaderMutation
	...
	17, // 5: hashicorp.consul.mesh.v2beta1.pbproxystate.RouteRule.header_mutations:type_name -> hashicorp.consul.mesh.v2beta1.pbproxystate.HeaderMutation
	...
	16, // 9: hashicorp.consul.mesh.v2beta1.pbproxystate.RouteDestination.cluster:type_name -> hashicorp.consul.mesh.v2beta1.pbproxystate.DestinationCluster
...
func file_pbmesh_v2beta1_pbproxystate_route_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pbmesh_v2beta1_pbproxystate_route_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
