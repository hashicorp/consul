...
var file_pbmesh_v2beta1_pbproxystate_access_logs_proto_goTypes = []any{
...
func file_pbmesh_v2beta1_pbproxystate_access_logs_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_pbmesh_v2beta1_pbproxystate_access_logs_proto_msgTypes[0].Exporter = func(v any, i int) any {
	...
	file_pbmesh_v2beta1_pbproxystate_access_logs_proto_msgTypes[0].OneofWrappers = []any{
		(*AccessLogs_Json)(nil),
		(*AccessLogs_Text)(nil),
	}
	type x struct{}
