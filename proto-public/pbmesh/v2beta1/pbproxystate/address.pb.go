...
// 	protoc        (unknown)
// source: pbmesh/v2beta1/pbproxystate/address.proto
...
func (x *HostPortAddress) Reset() {
	*x = HostPortAddress{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pbmesh_v2beta1_pbproxystate_address_proto_msgTypes[0]
...
func (*HostPortAddress) Descriptor() ([]byte, []int) {
	return file_pbmesh_v2beta1_pbproxystate_address_proto_rawDescGZIP(), []int{0}
}
...
func (x *UnixSocketAddress) Reset() {
	*x = UnixSocketAddress{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pbmesh_v2beta1_pbproxystate_address_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*UnixSocketAddress) Descriptor() ([]byte, []int) {
	return file_pbmesh_v2beta1_pbproxystate_address_proto_rawDescGZIP(), []int{1}
}
...
var file_pbmesh_v2beta1_pbproxystate_address_proto_rawDesc = []byte{
	0x0a, 0x29, 0x70, 0x62, 0x6d, 0x65, 0x73, 0x68, 0x2f, 0x76, 0x32, 0x62, 0x65, 0x74, 0x61, 0x31,
	0x2f, 0x70, 0x62, 0x70, 0x72, 0x6f, 0x78, 0x79, 0x73, 0x74, 0x61, 0x74, 0x65, 0x2f, 0x61, 0x64,
	0x64, 0x72, 0x65, 0x73, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x2a, 0x68, 0x61, 0x73,
	...
	0x78, 0x79, 0x73, 0x74, 0x61, 0x74, 0x65, 0x22, 0x39, 0x0a, 0x0f, 0x48, 0x6f, 0x73, 0x74, 0x50,
	0x6f, 0x72, 0x74, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x12, 0x0a, 0x04, 0x68, 0x6f,
	...
	0x72, 0x74, 0x22, 0x3b, 0x0a, 0x11, 0x55, 0x6e, 0x69, 0x78, 0x53, 0x6f, 0x63, 0x6b, 0x65, 0x74,
	0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x12, 0x0a, 0x04, 0x70, 0x61, 0x74, 0x68, 0x18,
	...
	0xd2, 0x02, 0x0a, 0x2e, 0x63, 0x6f, 0x6d, 0x2e, 0x68, 0x61, 0x73, 0x68, 0x69, 0x63, 0x6f, 0x72,
	...
	0x74, 0x65, 0x42, 0x0c, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x50, 0x72, 0x6f, 0x74, 0x6f,
...
var (
	file_pbmesh_v2beta1_pbproxystate_address_proto_rawDescOnce sync.Once
	file_pbmesh_v2beta1_pbproxystate_address_proto_rawDescData = file_pbmesh_v2beta1_pbproxystate_address_proto_rawDesc
)

func file_pbmesh_v2beta1_pbproxystate_address_proto_rawDescGZIP() []byte {
	file_pbmesh_v2beta1_pbproxystate_address_proto_rawDescOnce.Do(func() {
		file_pbmesh_v2beta1_pbproxystate_address_proto_rawDescData = protoimpl.X.CompressGZIP(file_pbmesh_v2beta1_pbproxystate_address_proto_rawDescData)
	})
	return file_pbmesh_v2beta1_pbproxystate_address_proto_rawDescData
}

var file_pbmesh_v2beta1_pbproxystate_address_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_pbmesh_v2beta1_pbproxystate_address_proto_goTypes = []interface{}{
	(*HostPortAddress)(nil),   // 0: hashicorp.consul.mesh.v2beta1.pbproxystate.HostPortAddress
	(*UnixSocketAddress)(nil), // 1: hashicorp.consul.mesh.v2beta1.pbproxystate.UnixSocketAddress
}
var file_pbmesh_v2beta1_pbproxystate_address_proto_depIdxs = []int32{
...
func init() { file_pbmesh_v2beta1_pbproxystate_address_proto_init() }
func file_pbmesh_v2beta1_pbproxystate_address_proto_init() {
	if File_pbmesh_v2beta1_pbproxystate_address_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_pbmesh_v2beta1_pbproxystate_address_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pbmesh_v2beta1_pbproxystate_address_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_pbmesh_v2beta1_pbproxystate_address_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pbmesh_v2beta1_pbproxystate_address_proto_goTypes,
		DependencyIndexes: file_pbmesh_v2beta1_pbproxystate_address_proto_depIdxs,
		MessageInfos:      file_pbmesh_v2beta1_pbproxystate_address_proto_msgTypes,
	}.Build()
	File_pbmesh_v2beta1_pbproxystate_address_proto = out.File
	file_pbmesh_v2beta1_pbproxystate_address_proto_rawDesc = nil
	file_pbmesh_v2beta1_pbproxystate_address_proto_goTypes = nil
	file_pbmesh_v2beta1_pbproxystate_address_proto_depIdxs = nil
}
