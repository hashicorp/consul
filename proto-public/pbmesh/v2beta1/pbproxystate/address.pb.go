...
var file_pbmesh_v2beta1_pbproxystate_address_proto_goTypes = []any{
...
func file_pbmesh_v2beta1_pbproxystate_address_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_pbmesh_v2beta1_pbproxystate_address_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_pbmesh_v2beta1_pbproxystate_address_proto_msgTypes[1].Exporter = func(v any, i int) any {
