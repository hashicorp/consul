...
var file_pbmesh_v2beta1_pbproxystate_escape_hatches_proto_goTypes = []any{
...
func file_pbmesh_v2beta1_pbproxystate_escape_hatches_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_pbmesh_v2beta1_pbproxystate_escape_hatches_proto_msgTypes[0].Exporter = func(v any, i int) any {
