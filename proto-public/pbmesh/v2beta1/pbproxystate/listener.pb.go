...
var file_pbmesh_v2beta1_pbproxystate_listener_proto_goTypes = []any{
...
func file_pbmesh_v2beta1_pbproxystate_listener_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_pbmesh_v2beta1_pbproxystate_listener_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_pbmesh_v2beta1_pbproxystate_listener_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Router); i {
			case 0:
				return &v.state
			case 1:
		...
		file_pbmesh_v2beta1_pbproxystate_listener_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*Match); i {
			case 0:
				return &v.state
			case 1:
		...
		file_pbmesh_v2beta1_pbproxystate_listener_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_pbmesh_v2beta1_pbproxystate_listener_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_pbmesh_v2beta1_pbproxystate_listener_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_pbmesh_v2beta1_pbproxystate_listener_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_pbmesh_v2beta1_pbproxystate_listener_proto_msgTypes[7].Exporter = func(v any, i int) any {
	...
	file_pbmesh_v2beta1_pbproxystate_listener_proto_msgTypes[0].OneofWrappers = []any{
		(*Listener_HostPort)(nil),
		(*Listener_UnixSocket)(nil),
	}
	file_pbmesh_v2beta1_pbproxystate_listener_proto_msgTypes[1].OneofWrappers = []any{
		(*Router_L4)(nil),
		(*Router_L7)(nil),
		(*Router_Sni)(nil),
	}
	file_pbmesh_v2beta1_pbproxystate_listener_proto_msgTypes[4].OneofWrappers = []any{
