...
var file_proto_public_pbacl_acl_proto_goTypes = []any{
...
func file_proto_public_pbacl_acl_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_public_pbacl_acl_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_proto_public_pbacl_acl_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_proto_public_pbacl_acl_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_proto_public_pbacl_acl_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_proto_public_pbacl_acl_proto_msgTypes[4].Exporter = func(v any, i int) any {
