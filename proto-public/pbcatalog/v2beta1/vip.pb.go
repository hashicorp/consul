...
var file_pbcatalog_v2beta1_vip_proto_goTypes = []any{
...
func file_pbcatalog_v2beta1_vip_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_pbcatalog_v2beta1_vip_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_pbcatalog_v2beta1_vip_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*IP); i {
			case 0:
				return &v.state
			case 1:
