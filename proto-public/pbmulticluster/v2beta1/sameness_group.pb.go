...
var file_pbmulticluster_v2beta1_sameness_group_proto_goTypes = []any{
...
func file_pbmulticluster_v2beta1_sameness_group_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_pbmulticluster_v2beta1_sameness_group_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_pbmulticluster_v2beta1_sameness_group_proto_msgTypes[1].Exporter = func(v any, i int) any {
	...
	file_pbmulticluster_v2beta1_sameness_group_proto_msgTypes[1].OneofWrappers = []any{
