...
[Securing RPC Communication with TLS Encryption guide](https://learn.hashicorp.com/consul/security-networking/certificates) to learn how. This guide details the step-by-step process for configuring TLS on a new or existing cluster. Note the call outs for specific information for
an existing cluster. 
