...
command blocks, running forever or until told to quit. You can test a local agent with the [Getting Started guides](https://learn.hashicorp.com/consul/getting-started/install).
