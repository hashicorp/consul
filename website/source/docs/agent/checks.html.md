...
service. Review the [Getting Started guide](https://learn.hashicorp.com/consul/getting-started/services) for a complete example of a application-level health check. 
