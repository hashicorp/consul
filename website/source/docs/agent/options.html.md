...
* Serf WAN (Default 8302). This is used by servers to gossip over the WAN to
  other servers. TCP and UDP. As of Consul 0.8, it is recommended that you
  configure the LAN and WAN interfaces to both use port 8302; the WAN Join
  Flooding feature leverages LAN membership. See also:
