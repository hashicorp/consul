...
* <a name="_log_file"></a><a href="#_log_file">`-log-file`</a> - to redirect all the Consul agent log messages to a file. This should be specified with the complete path along with the name of the log. You can skip this if you've specified a <a href="#_data_dir">data-dir</a>. If <a href="#_data_dir">data-dir</a> is specified, logs are written to it by default.  Can be combined with <a href="#_log_rotate_bytes"> -log-rotate-bytes</a> and <a href="#_log_rotate_duration"> -log-rotate-duration </a> for a fine-grained log rotation experience. 
