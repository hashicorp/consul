...
consul-server-0                            10.60.0.187:8301  alive   server  1.7.0+ent  2         dc1  <all>
consul-server-1                            10.60.1.229:8301  alive   server  1.7.0+ent  2         dc1  <all>
consul-server-2                            10.60.2.197:8301  alive   server  1.7.0+ent  2         dc1  <all>
```
