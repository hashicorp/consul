...
-> **1.3.0 and earlier:** This document only applies in Consul versions 1.3.0 and before. If you are using the 1.4.0 or later please use the updated documentation [here](/docs/acl/acl-system.html)
