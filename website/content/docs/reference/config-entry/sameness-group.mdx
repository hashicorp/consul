...
To learn more about creating a sameness group, refer to [Create sameness groups](/consul/docs/link/sameness-group) or [Create sameness groups on Kubernetes](/consul/docs/link/sameness-group).
