...
To learn more about creating a sameness group, refer to [Create sameness groups](/consul/docs/multi-tenant/sameness-group/vm) or [Create sameness groups on Kubernetes](/consul/docs/k8s/connect/cluster-peering/usage/create-sameness-groups).
