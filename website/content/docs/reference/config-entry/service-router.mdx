...
Specifies the namespace to apply the configuration entry to. Refer to [Namespaces](/consul/docs/segment/namespace) for additional information about Consul namespaces.
...
Specifies the admin partition to apply the configuration entry to. Refer to [Admin partitions](/consul/docs/segment/admin-partition) for additional information.
