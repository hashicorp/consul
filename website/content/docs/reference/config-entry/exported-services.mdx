...
1. Specify the `exported-services` configuration in the agent configuration file (see [`config_entries`](/consul/docs/reference/agent#config_entries)) as described in [Configuration](#configuration).
