...
Specifies parameters for loading the TLS certificates from an external SDS service. Refer to [Serve custom TLS certificates from an external service](/consul/docs/connect/access/ingress-gateway/tls-external-service) for additional information.
...
Specifies parameters that configure the listener to load TLS certificates from an external SDS. Refer to [Serve custom TLS certificates from an external service](/consul/docs/connect/access/ingress-gateway/tls-external-service) for additional information.
...
The following table describes how to configure SDS parameters. Refer to [Configure static SDS clusters](/consul/docs/connect/access/ingress-gateway/tls-external-service#configure-static-sds-clusters) for usage information:
...
The following table describes how to configure SDS parameters. Refer to [Serve custom TLS certificates from an external service](/consul/docs/connect/access/ingress-gateway/tls-external-service) for usage information:
