...
Specifies the [namespace](/consul/docs/segment/namespace) to apply the configuration entry.
...
Specifies the [admin partition](/consul/docs/segment/admin-partition) to apply the configuration entry.
...
Specifies the [namespace](/consul/docs/segment/namespace) to use in the FQDN when resolving the service. 
...
Specifies the [admin partition](/consul/docs/segment/admin-partition) to use in the FQDN when resolving the service. 
...
Specifies the [namespace](/consul/docs/segment/namespace) to use when resolving the service. 
...
Specifies which [admin partition](/consul/docs/segment/admin-partition) to use in the FQDN when resolving the service. 
