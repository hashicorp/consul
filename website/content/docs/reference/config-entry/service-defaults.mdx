...
Map that contains the default mesh gateway `mode` field for the upstream. Refer to [Service Mesh Proxy Configuration](/consul/docs/link/mesh-gateway/#service-mesh-proxy-configuration) in the mesh gateway documentation for additional information.
...
Specifies the default mesh gateway `mode` field for all upstreams. Refer to [Service Mesh Proxy Configuration](/consul/docs/link/mesh-gateway/#service-mesh-proxy-configuration) in the mesh gateway documentation for additional information.
...
Specifies the default mesh gateway `mode` field for the service. Refer to [Service Mesh Proxy Configuration](/consul/docs/link/mesh-gateway/#service-mesh-proxy-configuration) in the mesh gateway documentation for additional information.
...
Map that contains the default mesh gateway `mode` field for the upstream. Refer to [Connect Proxy Configuration](/consul/docs/link/mesh-gateway/#connect-proxy-configuration) in the mesh gateway documentation for additional information.
