...
- `balance_inbound_connections` - The strategy used for balancing inbound connections
  ...
  [Envoy Exact Balance Strategy.](https://www.envoyproxy.io/docs/envoy/v1.35.3/api-v3/config/listener/v3/listener.proto.html#envoy-v3-api-field-config-listener-v3-listener-connectionbalanceconfig-exact-balance)
