...
# Access Control List (ACL) token configuration reference
...
| `Partition`         | <EnterpriseAlert inline/> Specifies the name of the admin partition in which the token is valid. See [Admin Partitions](/consul/docs/segment/admin-partition) for additional information.                                                              | String    | `default`      |
| `Namespace`         | <EnterpriseAlert inline/> Specifies the name of the Consul namespace in which the token is valid. See [Namespaces](/consul/docs/segment/namespace) for additional information.                                                                         | String    | `default`      |
