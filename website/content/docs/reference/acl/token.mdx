...
| `Partition`         | <EnterpriseAlert inline/> Specifies the name of the admin partition in which the token is valid. Refer to  [Admin Partitions](/consul/docs/enterprise/admin-partitions) for additional information.                                                              | String    | `default`      |
