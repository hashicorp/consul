...
# ACL role configuration reference
...
1. Assemble rules into [policies](/consul/docs/secure-consul/acl/policies) and register them in Consul.
...
Refer to the [rules reference](/consul/docs/secure-consul/acl/rules) for information about the rules in the policy.
