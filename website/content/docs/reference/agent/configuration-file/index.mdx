...
For information about how to start Consul agents and where to place
configuration files, refer to [Consul agent
fundamentals](/consul/docs/fundamentals/agent).
