...
Specifies the namespace that the proxy configuration applies to. Refer to [namespaces](/consul/docs/segment/namespace) for more information.
...
Specifies initial bootstrap settings for the Envoy proxy, as well as proxy configuration settings that require the proxy to restart when applied. For more information, refer to [Envoy proxy bootstrap configuration](/consul/docs/reference/proxy/envoy#bootstrap-configuration).
...
Refer to [Envoy proxy escape-hatch overrides](/consul/docs/reference/proxy/envoy#escape-hatch-overrides) for more information.
...
Refer to [Envoy proxy advanced bootstrap options](/consul/docs/reference/proxy/envoy#advanced-bootstrap-options) for more information and examples.
...
Specifies configuration settings for the Envoy proxy that are applied without restarting the proxy. For more information, refer to [Envoy proxy dynamic configuration](/consul/docs/reference/proxy/envoy#dynamic-configuration).
...
Refer to [expose paths configuration reference](/consul/docs/reference/proxy/connect-proxy#expose-paths-configuration-reference) for more information.
...
Specifies the proxy's mode of operation for resolving upstreams in remote datacenter destinations. Refer to [Mesh gateway configuration reference](/consul/docs/reference/proxy/connect-proxy#mesh-gateway-configuration-reference) for more information.
...
Configures the proxy to operate in transparent, direct, or default mode. Refer to [proxy modes](/consul/docs/reference/proxy/connect-proxy#proxy-modes) for more information.
...
Specifies a complete Envoy listener for Consul to deliver in place of the main public listener that the proxy uses to accept inbound connections. Refer to [escape-hatch overrides](/consul/docs/reference/proxy/envoy#escape-hatch-overrides) for more information
...
Specifies additional configurations for operating proxies in transparent proxy mode.  Refer to [transparent proxy configuration reference](/consul/docs/reference/proxy/connect-proxy#transparent-proxy-configuration-reference) for more information.
