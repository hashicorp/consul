...
~> By default CTS is configured to automatically retrieve a license from its configured Consul Enterprise Backend, and also retrieve new licenses periodically. For more information review [License](/docs/nia/configuration#license-1) configuration.
