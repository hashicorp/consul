...
After running Consul-Terraform-Sync Enterprise, your license will eventually approach expiration, and you'll want to update to a new license. To do so, have the new license value at hand or saved in a file to disk.

Steps to update to a new license:
1. Update the license environment variable or configuration that you used to set the prior license with the new license value or file path
