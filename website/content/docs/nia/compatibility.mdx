...
|             **HCP Consul**<br/><span><sub>1.8+</sub></span>             |             <span style={{color:'#2EB039'}}>&check;</span>              |                 <span style={{color:'#2EB039'}}>&check;</span>                 |
|                                                                                                    |
|        **Terraform OSS**<br/><span><sub>0.13 - 1.0</sub></span>        |             <span style={{color:'#2EB039'}}>&check;</span>              |                  <span style={{color:'#2EB039'}}>&check;</span>                 |
...
|            **\*HCP Vault**<br/><span><sub>0.7+</sub></span>             |             <span style={{color:'#2EB039'}}>&check;</span>              |                 <span style={{color:'#2EB039'}}>&check;</span>                 |
