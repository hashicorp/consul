...
- Follow the documentation to [install Consul](/docs/install) either with a precompiled binary or from source.
...
<div style={{ color: 'red', border: '1px solid gray', padding: '16px' }}>
  hello
</div>
