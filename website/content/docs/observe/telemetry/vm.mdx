...
visualizations. See our [Kubernetes observability docs](/consul/docs/observe/mesh/k8s) for more information.
...
-> **Note**: For more information on configuring the observability UI on Kubernetes, use this [reference](/consul/docs/observe/mesh/k8s).
...
[Single Sign-On integration](/consul/docs/secure/acl/auth-methods/oidc) (Consul
