...
gRPC](/consul/docs/reference/agent/configuration-file#grpc_port) on your client agents. To define the
metrics destination and service protocol you may want to enable [configuration
entries](/consul/docs/reference/agent/configuration-file#config_entries) and [centralized service
configuration](/consul/docs/reference/agent/configuration-file#enable_central_service_config).
