---
layout: docs
page_title: Observe service mesh with Consul UI visualizations
description: >-
...
# Observe service mesh with Consul UI visualizations
...
[Single Sign-On integration](/consul/docs/secure-consul/acl/auth-methods/oidc) (Consul
