...
Refer to the [Wasm extension configuration reference](/consul/docs/reference/proxy/envoy-extensions/configuration/wasm) for details on how to configure the extension. 
