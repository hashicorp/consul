...
Refer to the [OpenTelemetry Access Logging extension configuration reference](/consul/docs/reference/proxy/envoy-extensions/configuration/otel-access-logging) for details on how to configure the extension.
