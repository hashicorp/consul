...
Refer to the [external authorization extension configuration reference](/consul/docs/reference/proxy/envoy-extensions/configuration/ext-authz) for details on how to configure the extension. 
