...
There is [updated documentation for the new ACL system](/docs/security/acl). For information on how to migrate to the new ACL System, refer to the [Migrate Legacy ACL Tokens](https://learn.hashicorp.com/tutorials/consul/access-control-token-migration) tutorial.
