...
description: >-
    ACL rules grant or deny access to specific resources. This page provides a reference
    for all ACL rules.
---

# ACL Rules

This page describes how to configure rules for Consul's access control list (ACL) system. The ACL system enables you to control access to data and APIs. Refer to the [ACL system documentation](/docs/acl/acl-system) to learn more about ACLs.
