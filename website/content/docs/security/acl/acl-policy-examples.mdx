...
Identities](/docs/security/acl#service-identities) rather than creating a custom policy. The service
...
Permissions](/docs/connect/intentions#intention-management-permissions) for details.
...
necessary. We recommend using [Node Identities](/docs/security/acl#node-identities) rather than creating
...
peering](/docs/connect/cluster-peering#differences-between-wan-federation-and-cluster-peering).
