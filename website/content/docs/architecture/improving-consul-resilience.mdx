...
![Reference architecture diagram for Consul Redundancy zones](/img/architecture/consul-singleDC-redundancyzones.png)
...
![Reference architecture diagram for Consul cluster peering](/img/architecture/cluster-peering-diagram.png)
