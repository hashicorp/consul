...
Fault tolerance and failure tolerance are often used interchangably. Fault tolerance is the ability of a system to continue operating without interruption
