...
Refer to the [Serf documentation](https://github.com/hashicorp/serf/docs/internals/gossip.html) for additional information about the gossip protocol.
...
[Serf gossip protocol guide](https://github.com/hashicorp/serf/docs/internals/gossip.html#lifeguard)
