...
- [API gateways](/consul/docs/north-south/api-gateway) enable external network clients to securely access applications and services running in a Consul datacenter.
...
For more information about ingress gateways, review the [complete documentation](/consul/docs/north-south/ingress-gateway)
...
Services outside the mesh do not have sidecar proxies or are not [integrated natively](/consul/docs/automate/native).
...
For more information about terminating gateways, review the [complete documentation](/consul/docs/north-south/terminating-gateway)
