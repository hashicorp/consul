...
against the configured set of Consul [intentions](/consul/docs/secure-mesh/intention),
...
also ships with built-in support for [Vault](/consul/docs/secure-mesh/certificate/vault). The PKI system is designed to be pluggable
...
[Intentions](/consul/docs/secure-mesh/intention) verify connections between services by
...
[`primary_datacenter`](/consul/docs/reference/agent/configuration-file#primary_datacenter)
...
[replication token](/consul/docs/reference/agent/configuration-file#acl_tokens_replication) must also
