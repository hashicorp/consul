...
The cloud or on-premise infrastructure underlying your  [Consul datacenter](/consul/docs/reference/glossary#datacenter)
...
Consul Enterprise [redundancy zones](/consul/docs/manage-consul/redundancy-zones)
...
- [Redundancy zone documentation](/consul/docs/manage-consul/redundancy-zones)
  for a more detailed explanation
- [Redundancy zone tutorial](/consul/tutorials/manage-consul/redundancy-zones-zones)
