...
- [Consul compares with other service meshes](/consul/docs/use-case/service-mesh)
- [Consul compares with other DNS tools](/consul/docs/use-case/dns)
- [Consul compares with other configuration management tools](/consul/docs/use-case/config-management)
- [Consul compares with other API Gateways](/consul/docs/use-case/api-gateway)