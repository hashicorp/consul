...
Refer to [Initialize Rate Limit Settings](/consul/docs/manage-consul/agent-rate-limit/initialize) for additional information about right-sizing your gRPC request configurations.
...
You should continue to monitor request traffic to ensure that request rates remain within the threshold you defined. Refer to [Monitor traffic rate limit data](/consul/docs/manage-consul/agent-rate-limit/monitor) for instructions about checking metrics and log entries, as well as troubleshooting information.
