...
- Set the rate limiter [`mode`](/consul/docs/reference/agent#mode-1)
- Set the [`read_rate`](/consul/docs/reference/agent#read_rate)
- Set the [`write_rate`](/consul/docs/reference/agent#write_rate)
