...
For more details, review the [Consul server configuration](/consul/docs/agent/config) documentation and the [-read-replica](/consul/docs/agent/config/cli-flags#_read_replica) configuration flag.
