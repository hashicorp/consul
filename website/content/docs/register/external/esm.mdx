...
[`-enable-script-checks`](/consul/docs/reference/agent/configuration-file/general#enable_script_checks)
...
~> **Security Warning**: Because [`-enable-script-checks`](/consul/docs/reference/agent/configuration-file/general#enable_script_checks)
...
[`-enable-local-script-checks`](/consul/docs/reference/agent//configuration-file/general#enable_local_script_checks)
instead, which removes that vulnerability by allowing script checks to only be
defined in the Consul agent's [local configuration files](/consul/docs/reference/agent/configuration-file/),
not via HTTP API.
