...
Refer to the [service mesh observability overview](/consul/docs/observe/tech-specs) and [metrics configuration for Consul on Kubernetes documentation](/consul/docs/observe/mesh/k8s) for additional information.
