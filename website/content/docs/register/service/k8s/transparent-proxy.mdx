...
Refer to the [service mesh observability overview](/consul/docs/observe/tech-specs) and [metrics configuration for Consul on Kubernetes documentation](/consul/docs/k8s/connect/observability/metrics) for additional information.
