...
Active Consul Enterprise [Long Term Support (LTS)](/consul/docs/enterprise/long-term-support) releases expand their Kubernetes version compatibility window until the LTS release reaches its end of maintenance.
