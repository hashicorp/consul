...
consider upgrading to the lastest available version to take advantage of all
...
Lastly, if you are using Consul service mesh, you should set [`enable_central_service_config = true`](/consul/docs/reference/agent/configuration-file#enable_central_service_config)
...
- [Upgrade Instructions](/consul/docs/consul/docs/upgrade/instructions)
...
Temporarily modify your Consul server configuration so that their [log_level](/consul/docs/reference/agent/configuration-file#_log_level) 
