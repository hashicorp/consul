...
older than 1.6.9, please follow the link for the version you are on from [here](/consul/docs/consul/docs/upgrade/instructions).
...
**3.** Upgrade the Consul agents in all DCs to version 1.8.19 by following our [General Upgrade Process](/consul/docs/consul/docs/upgrade/instructions/general-process).
