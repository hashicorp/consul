...
[General Upgrade Process](/consul/docs/consul/docs/upgrade/instructions/general-process). If you are on a version
...
**3.** Upgrade the Consul agents in all DCs to version 1.2.4 by following our [General Upgrade Process](/consul/docs/consul/docs/upgrade/instructions/general-process).
