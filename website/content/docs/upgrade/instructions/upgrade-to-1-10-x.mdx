...
version of Consul prior to 1.8, you must first [upgrade to latest 1.8.x](/consul/docs/consul/docs/upgrade/instructions/upgrade-to-1-8-x)
...
[General Upgrade Process](/consul/docs/consul/docs/upgrade/instructions/general-process).
...
- You are familiar with the [General Upgrade Process](/consul/docs/consul/docs/upgrade/instructions/general-process).
...
Refer to our documentation for the [basic server upgrade process](/consul/docs/consul/docs/upgrade/instructions/general-process),
