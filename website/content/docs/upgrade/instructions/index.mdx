...
| ---------------------- | ------------------- | -------------------- |
| 1.8.0 - 1.9.17         | 1.10.12             | Refer to [upgrading to latest 1.10.x](/consul/docs/consul/docs/upgrade/instructions/upgrade-to-1-10-x) |
| 1.6.9 - 1.8.18         | 1.8.19              | Refer to [upgrading to latest 1.8.x](/consul/docs/consul/docs/upgrade/instructions/upgrade-to-1-8-x) |
| 1.2.4 - 1.6.9          | 1.6.10              | Refer to [upgrading to latest 1.6.x](/consul/docs/consul/docs/upgrade/instructions/upgrade-to-1-6-x) |
| 0.8.5 - 1.2.3          | 1.2.4               | Refer to [upgrading to latest 1.2.x](/consul/docs/consul/docs/upgrade/instructions/upgrade-to-1-2-x) |
