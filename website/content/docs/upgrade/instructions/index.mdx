...
1. Upgrade to Consul 1.14 as an intermediate step.
   ...
   [1.13](/consul/docs/upgrade/version-specific#consul-1-13-x) and
   [1.14](/consul/docs/upgrade/version-specific#consul-1-14-x).
1. Upgrade to Consul 1.15.
   To plan, review the upgrade details for
   [1.15](/consul/docs/upgrade/version-specific#consul-1-15-x).
...
| ---------------------- | ------------------- | -------------------- |
| 1.8.0 - 1.9.17         | 1.10.12             | Refer to [upgrading to latest 1.10.x](/consul/docs/upgrade/instructions/1-10-x) |
| 1.6.9 - 1.8.18         | 1.8.19              | Refer to [upgrading to latest 1.8.x](/consul/docs/upgrade/instructions/1-8-x) |
| 1.2.4 - 1.6.9          | 1.6.10              | Refer to [upgrading to latest 1.6.x](/consul/docs/upgrade/instructions/1-6-x) |
| 0.8.5 - 1.2.3          | 1.2.4               | Refer to [upgrading to latest 1.2.x](/consul/docs/upgrade/instructions/1-2-x) |
