...
are called out in our [Specific Version Details](/consul/docs/upgrade/version-specific#consul-1-1-0)
...
- [Upgrade Specific Versions: Consul 1.0 - Deprecated Options](/consul/docs/upgrade/version-specific#deprecated-options-have-been-removed)
