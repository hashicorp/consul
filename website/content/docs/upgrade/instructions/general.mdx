...
**2.** Temporarily modify your Consul configuration so that its [log_level](/consul/docsreference-cli/agent#_log_level)
...
- [Debug level logs](/consul/docsreference-cli/agent#_log_level) from all servers in the cluster
