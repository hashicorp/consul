...
CTS directs network infrastructure automation (NIA) activities according to the CTS configuration file. Specify configurations for the following components in the file: 
...
- **Connection to the Consul cluster**: 
