...
Each driver includes a set of providers that [enables support](/consul/docs/reference/cts/terraform-module) for a wide variety of infrastructure applications.
