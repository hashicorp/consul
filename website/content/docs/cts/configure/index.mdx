...
This topic describes how to define settings in the Consul-Terraform-Sync (CTS) configuration file.

## Overview

CTS directs network infrastructure automation (NIA) activities according to the CTS configuration file. Write the configuration file using Terraform configuration language and HCL syntax. Refer to the [Terraform configuration language reference](/terraform/language) to learn about the Terraform language. Refer to the [HCL reference](https://github.com/hashicorp/hcl) in GitHub for information about the HCL syntax.

Configure the following components in the file to configure how CTS works:
