...
For general guidance for managing cluster peering connections, refer to [Manage L7 traffic with cluster peering](/consul/docs/east-west/cluster-peering/usage/peering-traffic-management).
...
1. After updating `PeeringAcceptor`, repeat all of the steps to [establish a new peering connection](/consul/docs/east-west/cluster-peering/establish-connection/k8s).
