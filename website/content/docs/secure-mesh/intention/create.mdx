...
- TLS must be enabled to enforce L4 intentions. Refer to [Encryption](/consul/docs/secure-consul/encryption) for additional information.
...
[service defaults configuration entry](/consul/docs/reference/config-entry/service-default)
