...
bootstrap by default when you first [enable](/consul/docs/agent/config/config-files#connect_enabled) Consul service mesh on your servers.
...
configuration](/consul/docs/connect/ca/consul#specifying-a-custom-private-key-and-root-certificate).
...
CA](/consul/docs/connect/ca/vault) once
