...
# Use AWS Certificate Manager as a service mesh certificate authority
...
[`leaf_cert_ttl`](/consul/docs/reference/agent#ca_leaf_cert_ttl) in the CA Provider
configuration if the longer lived credentials are an acceptable risk tradeoff
against the cost.

<!-- Reference style links -->
[`ca_config`]: /consul/docs/reference/agent#connect_ca_config
[`ca_provider`]: /consul/docs/reference/agent#connect_ca_provider
