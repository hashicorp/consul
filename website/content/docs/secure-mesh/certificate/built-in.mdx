...
[updated and rotated](/consul/docs/secure-mesh/certificate#root-certificate-rotation)
...
either through the `ca_config` section of the [Agent configuration](/consul/docs/reference/agent#connect_ca_config) (which can only be used during the cluster's
