...
either through the `ca_config` section of the [Agent configuration](/consul/docs/reference/agent/configuration-file#connect_ca_config) (which can only be used during the cluster's
