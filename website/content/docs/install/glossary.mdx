...
See also [Identity-based Authorization](link to that glossary term).
See also [Role-based Access Controls](link to that glossary term).
...
See also [Server-side Load Balancing](link to that glossary term).
...
Definition (CRD) file allows a user to define their own custom resources and 
...
See also [Ingress Traffic](link to that glossary term).
...
See also [Reverse Proxy](link to that glossary term).
...
See also [Multi-cloud](link to that glossary term).
...
See also [Software as a Service](link to that glossary term).
See also [Platform as a Service](link to that glossary term).

## Infrastructure as Code	
Infrastructure as Code is the process of developers and operations teams' 
...
## Load Balancer	
A load balancer is a network appliance that acts as a [reverse proxy] (link to that
glossary term) and distributes network and application traffic across the servers.
...
See also [Hybrid Cloud](link to that glossary term).
...
traffic.  
See also [Forward Proxy](link to that glossary term).

## Role-based Access Controls	"The act of restricting or provisioning access 
to a user based on their specific role in the organization.

See also [AuthZ and AuthN](link to that glossary term).
See also [Identity-based Authorization](link to that glossary term).
...
See also [Client-side Load Balancing](link to that glossary term). 
See also [Load Balancing Methods](link to that glossary term).
...
Service instances are registered with a [service registry](link to that 
glossary term) on startup and deregistered at shutdown.
...
inter-service communication, if the ability of a microservice 
...
See also [Infrastructure as a Service](link to that glossary term).
See also [Platform as a Service](link to that glossary term).
