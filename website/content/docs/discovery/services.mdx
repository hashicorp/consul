...
| `connect`             | Object that configures a Consul service mesh connection. See [Connect](#connect) for details.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | None                          | Optional                     |
...
Different Consul service mesh parameters are supported for different Consul versions. The following table describes changes applicable to service discovery.
