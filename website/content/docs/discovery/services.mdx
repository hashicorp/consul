...
address for the instances of a given logical service. Egress proxy connections
to an upstream service will be destined to the IP address of the selected
service instance, not the logical, virtual address.
