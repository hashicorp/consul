...
For node lookups, only the partition and datacenter need to be specified as part of the DNS query, as nodes cannot be
namespaced.
...
### Service Virtual IP Lookups for Namespaces and Admin Partitions <EnterpriseAlert inline />
