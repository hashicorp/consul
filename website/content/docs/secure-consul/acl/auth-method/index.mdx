...
| ------------------------------------------------- | --------------------------------- |
| [`kubernetes`](/consul/docs/secure-consul/acl/auth-methods/kubernetes) | 1.5.0+                            |
| [`jwt`](/consul/docs/secure-consul/acl/auth-methods/jwt)               | 1.8.0+                            |
| [`oidc`](/consul/docs/secure-consul/acl/auth-methods/oidc)             | 1.8.0+ <EnterpriseAlert inline /> |
| [`aws-iam`](/consul/docs/secure-consul/acl/auth-methods/aws-iam)       | 1.12.0+                           |
...
[ACL token replication](/consul/docs/reference/agent#acl_enable_token_replication)
...
linking [roles](/consul/docs/reference/acl/rule) and [service
identities](/consul/docs/reference/acl/rule#service-identities) to newly created
...
- **Bind Type and Name** - A binding rule can bind a token to a
  [role](/consul/docs/reference/acl/rule) or to a [service
  identity](/consul/docs/reference/acl/rule#service-identities) by name. The name
