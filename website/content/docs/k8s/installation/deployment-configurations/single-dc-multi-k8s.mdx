...
~> *Note:* If multiple Kubernetes clusters will be joined to the Consul Datacenter, then the following instructions below will need to be repeated for each additional Kubernetes cluster.
