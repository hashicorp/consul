...
The Consul Helm Chart is responsible for installation of the Consul CNI plugin.
To install and configure the plugin add the following configuration to your `config.yaml` file:
