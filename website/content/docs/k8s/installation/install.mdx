...
1. Issue the following command to install Consul with the default configuration using Helm 3.2+. You could also install Consul on a dedicated 
   namesapce of your choosing by modifying the value of the `-n` flag for the Helm install.
