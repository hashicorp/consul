...
Starting with Consul Kubernetes 0.33.0, Consul Kubernetes versions all of it components (`conusl-k8s` CLI, `consul-k8s-control-plane`, and Helm chart) with a single version. 
