---
layout: docs
page_title: Storing ACL Replication Token in Vault
description: >-
  Configuring the Consul Helm chart to use ACL replication token stored in Vault.
---
...
## Overview
To use an ACL replication token stored in Vault, we will follow the steps outlined in the [Data Integration](/docs/k8s/installation/vault/data-integration):
