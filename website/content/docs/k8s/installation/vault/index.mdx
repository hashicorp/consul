...
The following secrets can be stored in Vault KV secrets enginer, which is meant to handle arbitraty secrets:
- **Bootstrap token**
...
- [System Integration](/docs/k8s/installation/vault/system-integration).
- [Data Integration](/docs/k8s/installation/vault/data-integration) 

As a next step, please proceed to Vault integration with Consul on Kubernetes' [System Integration](/docs/k8s/installation/vault/system-integration)
