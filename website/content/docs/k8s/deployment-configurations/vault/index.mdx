...
1. [Cluster Peering](/consul/docs/k8s/connect/cluster-peering/tech-specs) is currently not supported for use with the Vault Secrets backend.
1. [Consul API Gateway](/consul/docs/api-gateway) is currently not supported for use with the Vault Secrets backend. 
