...
- `syncCatalog` ((#v-synccatalog)) - Configure the catalog sync process to sync K8S with Consul
  ...
  - `logLevel` ((#v-synccatalog-loglevel)) (`string: ""`) - Override global log verbosity level. One of "trace", "debug", "info", "warn", or "error".
...
- `connectInject` ((#v-connectinject)) - Configures the automatic Connect sidecar injector.
  ...
  - `logLevel` ((#v-connectinject-loglevel)) (`string: ""`) - Override global log verbosity level. One of "trace", "debug", "info", "warn", or "error".
...
- `apiGateway` ((#v-apigateway)) - Configuration settings for the Consul API Gateway integration
  ...
  - `logLevel` ((#v-apigateway-loglevel)) (`string: info`) - Override global log verbosity level for api-gateway-controller pods. OOne of "trace", "debug", "info", "warn", or "error".
