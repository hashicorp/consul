...
- `global` ((#v-global)) - Holds values that affect multiple components of the chart.
  ...
  - `imagePullPolicy` ((#v-global-imagePullPolicy)) (`string: ""`) - The image pull policy used globally for images
    controlled by Consul (consul, consul-dataplane, consul-k8s, consul-telemetry-collector).
