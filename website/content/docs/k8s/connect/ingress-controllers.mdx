...
```yaml
# An example list of pod annotations for an ingress controller.
  podAnnotations:
    consul.hashicorp.com/connect-inject: "true"
    consul.hashicorp.com/transparent-proxy-exclude-inbound-ports: "80,8000,9000,8443"
    # And the CIDR of your Kubernetes API svc
...
```yaml
# example L4 intention, but an L7 intention can also be used to enforce traffic to specific routes.
apiVersion: consul.hashicorp.com/v1alpha1
