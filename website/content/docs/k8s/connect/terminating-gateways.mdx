...
```shell-session
consul acl role list | grep -B 6 -- "- RELEASE_NAME-terminating-gateway-terminating-gateway-policy" | grep ID
...
AccessorID:       <role id>
SecretID:         <secret id>
Description:      RELEASE_NAME-terminating-gateway-terminating-gateway-acl-role
Local:            true
Create Time:      2021-01-08 21:18:47.957450486 +0000 UTC
Policies:
   63bf1d9b-a87d-8672-ddcb-d25e2d88adb8 - RELEASE_NAME-terminating-gateway-terminating-gateway-policy
