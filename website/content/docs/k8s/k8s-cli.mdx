...
Since Homebrew does not provide a way to install previous versions of packages, follow the below instructions to install the Consul K8S CLI to a version that matches your Control Plane deployment. 
