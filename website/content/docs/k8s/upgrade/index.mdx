...
1. List all available versions. Here we can see that the latest version of `0.40.0`.
...
1. Determine your current installed chart version. In this example, version `0.40.0` (from `consul-k8s:0.40.0`) is being used.
