...
Here we can see that the latest version of `0.40.0`.
...
If you want to upgrade to the latest `0.40.1` version, use the following procedure:
...
In this example, version `0.40.0` (from `consul-k8s:0.40.0`) is being used.
