...
If your version of Consul uses client agents on Kubernetes, consider [upgrading to the latest release](/docs/k8s/upgrade). To access documentation for a previous release of Consul, select your version from the dropdown at the top of this page.