...
Consul Dataplane is the default proxy manager in Consul on Kubernetes 1.14 and later. If you are on Consul 1.13 or older, consider [upgrading to 1.14](/docs/k8s/upgrade) so that you can create an agent-less service mesh. 