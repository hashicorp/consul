...
After you [deploy one or more server agents](/consul/docs/deploy/server/docker), you can deploy a containerized   Consul client agent that joins the datacenter.  Do not use detached mode, so you can reference the client logs later.
