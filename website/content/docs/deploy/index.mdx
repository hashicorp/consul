...
You can find a specific edition's release on releases.hashicorp.com. To learn more about the differences in Consul editions and their available features, refer to [Consul edition fundamentals](/consul/docs/fundamentals/editions).
