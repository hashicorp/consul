...
- In Consul 0.9.3 and later, a new [`limits`](/consul/docs/reference/agent#limits) configuration is
...
To prevent any CPU spikes from a misconfigured client, RPC requests to the server should be [rate limited](/consul/docs/reference/agent#limits)
