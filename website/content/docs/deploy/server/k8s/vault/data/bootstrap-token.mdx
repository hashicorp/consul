...
To use an ACL bootstrap token stored in Vault, follow the steps outlined in the [Data Integration](/consul/docs/deploy/server/k8s/multi/vault/data-integration) section.
