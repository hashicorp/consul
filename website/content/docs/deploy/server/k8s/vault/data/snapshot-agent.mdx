...
To use a snapshot agent configuration stored in Vault, follow the steps outlined in the [Data Integration](/consul/docs/deploy/server/k8s/multi/vault/data-integration) section.
...
1. Read and completed the steps in the [Systems Integration](/consul/docs/deploy/server/k8s/multi/vault/system-integration) section of [Vault as a Secrets Backend](/consul/docs/deploy/server/k8s/multi/vault).
2. Read the [Data Integration Overview](/consul/docs/deploy/server/k8s/multi/vault/data-integration) section of [Vault as a Secrets Backend](/consul/docs/deploy/server/k8s/multi/vault).
