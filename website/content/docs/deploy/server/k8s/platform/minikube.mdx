...
In this tutorial, you deployed a Consul datacenter onto a `minikube` cluster. After deploying Consul, you interacted with Consul using the CLI, UI, and API. Finally, you deployed two services that use Consul to discover and communicate with each other.
