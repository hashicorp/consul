...
At least a three node EKS cluster is required to deploy Consul using the official Consul Helm chart. Create a three node cluster on EKS by following the the [EKS documentation](https://docs.aws.amazon.com/eks/latest/userguide/create-cluster.html). 
...
- [Creating EKS kubeconfig](https://docs.aws.amazon.com/eks/latest/userguide/create-kubeconfig.html)
...
<Note>
 ...
 You can review the official [Consul K8S CLI documentation](/consul/docs/reference/k8s/consul-k8s-cli) to learn more about additional settings.
...
<Note>
 ...
 You can review the official [Helm chart values](/consul/docs/reference/k8s/helm#configuration-values) to learn more about the default settings.
...
![Consul UI Nodes](/img/consul/kubernetes-eks-aws-consul_view_nodes.png 'Consul UI Nodes')
