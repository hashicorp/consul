...
This page describes how to federate multiple Kubernetes clusters. Refer to [Multi-Cluster Overview](/consul/docs/link/wan-federation)
for more information, including [networking requirements](/consul/docs/link/wan-federation#network-requirements).
