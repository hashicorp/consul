...
To use Vault as the server TLS certificate provider on Kubernetes, complete a modified version of the steps outlined in the [Data Integration](/consul/docs/deploy/server/k8s/examples/vault/data-integration) section.
