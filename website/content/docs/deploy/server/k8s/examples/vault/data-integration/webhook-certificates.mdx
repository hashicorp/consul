...
To use Vault as the controller and connect inject Webhook Certificate Provider, we will need to modify the steps outlined in the [Data Integration](/consul/docs/deploy/server/k8s/examples/vault/data-integration) section:
...
1. Verify that you have completed the steps described in [Systems Integration](/consul/docs/deploy/server/k8s/examples/vault/system-integration) section of [Vault as a Secrets Backend](/consul/docs/deploy/server/k8s/examples/vault).
1. You should be familiar with the [Data Integration Overview](/consul/docs/deploy/server/k8s/examples/vault/data-integration) section of [Vault as a Secrets Backend](/consul/docs/deploy/server/k8s/examples/vault).
1. Configure [Vault as the Server TLS Certificate Provider on Kubernetes](/consul/docs/deploy/server/k8s/examples/vault/data-integration/server-tls)
1. Configure [Vault as the Service Mesh Certificate Provider on Kubernetes](/consul/docs/deploy/server/k8s/examples/vault/data-integration/service-mesh-certificate)
