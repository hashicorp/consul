...
- [Deploy a single Consul datacenter across multiple Kubernetes clusters](/consul/docs/deploy/server/k8s/multi/multiple-clusters)
- [Deploy Consul servers outside of Kubernetes](/consul/docs/deploy/server/k8s/multi/servers-outside)
- [Deploy Consul with Vault as Secrets backend](/consul/docs/deploy/server/k8s/multi/vault)
- [Deploy Consul servers to federated datacenters](/consul/docs/deploy/server/k8s/multi/federation)