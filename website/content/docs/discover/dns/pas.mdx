...
![Consul DNS and PCF](/img/consul/consul-pcf-arch.png 'Service discovery with Consul DNS')
...
domain](/consul/docs/agent/config/config-files#_domain), make sure to
...
![PCF UI](/img/consul/pcf-ui.png 'Configure PCF UI')
...
[Consul’s DNS interface](/consul/docs/services/discovery/dns-overview).
