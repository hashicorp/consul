...
load balancing. For more information about load balancing with Consul refer to the 
[Application load balancing](/consul/docs/discover/load-balancer) documentation section.
