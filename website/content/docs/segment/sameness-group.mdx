...
To establish cluster peering connections and define a group as part of the same workflow, follow instructions up to [Export services between clusters](/consul/docs/link/cluster-peering/establish-connection/vm#export-services-between-clusters). You can use the same exported services and service intention configuration entries to establish the cluster peering connection and create the sameness group.
...
Refer to [create and manage intentions](/consul/docs/secure-mesh/intentions/create) for more information about how to create and apply service intentions in Consul.
