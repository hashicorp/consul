...
- [View tutorial](https://learn.hashicorp.com/tutorials/consul/get-started-install) to use Consul on your local machine.
- [Compare Consul](/docs/intro/vs) against other software to assess its fit for your existing infrastructure.
- [Learn how](https://www.hashicorp.com/resources/connecting-apps-across-the-cloud) to connect apps across a multi-cloud environment using Consul.
