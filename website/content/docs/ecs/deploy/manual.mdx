...
The `tags` list must include the following tags if you are using the ACL controller in a [secure configuration](/consul/docs/ecs/manual/secure-configuration).
