...
For additional information about the `config.tf` file, refer to the [JSON schema reference documentation](/consul/docs/ecs/reference/configuration-reference). 
...
Mesh gateways require TLS and gossip encryption to be enabled. Refer to the [Requirements]() for additional information. 
