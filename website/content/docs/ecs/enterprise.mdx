...
### Audit Logging
Consul on ECS supports [audit logging](/docs/enterprise/audit-logging) when Consul Enterprise clients are used.
...
The following example demonstrates how to create a `mesh-task` with audit logging enabled.
