...
- [Install Consul on ECS with Terraform](/consul/docs/register/service/ecs/automatic)
...
- [Technical specifications](/consul/docs/register/service/ecs/requirements)
