...
Particularly useful in use cases where it's not trivial to capture *stdout* and/or *stderr* for example when Consul Template is deployed as a long running service.
