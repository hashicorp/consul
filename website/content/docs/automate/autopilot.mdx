...
[`raft_protocol`](/consul/docs/agent/config/config-files#_raft_protocol)
...
section](/consul/docs/upgrading/upgrade-specific) on Raft protocol
...
[autopilot settings](/consul/docs/agent/config/config-files#autopilot)
...
[last_contact_threshold](/consul/docs/agent/config/config-files#last_contact_threshold)
and
[max_trailing_logs](/consul/docs/agent/config/config-files#max_trailing_logs),
