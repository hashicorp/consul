...
[`raft_protocol`](/consul/docs/reference/agent/configuration-file#_raft_protocol)
...
[autopilot settings](/consul/docs/reference/agent/configuration-file#autopilot)
...
[last_contact_threshold](/consul/docs/reference/agent/configuration-file#last_contact_threshold)
and
[max_trailing_logs](/consul/docs/reference/agent/configuration-file#max_trailing_logs),
