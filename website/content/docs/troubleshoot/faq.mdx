...
See [`disable_anonymous_signature`](/consul/docs/reference/agent/configuration-file#disable_anonymous_signature)
and [`disable_update_check`](/consul/docs/reference/agent/configuration-file#disable_update_check).
...
The [Ports Used](/consul/docs/reference/agent/configuration-file#ports) section of the Configuration
...
[`kv_max_value_size`](/consul/docs/reference/agent/configuration-file#kv_max_value_size) configuration option.

It should be noted that the Consul key/value store is not designed to be used as
a general purpose database. See
[Server Performance](/consul/docs/reference/server) for more details.
