...
- Consul [service mesh](/consul/docs/reference/agent/configuration-file#connect) must be enabled on the datacenter's Consul servers.
- [gRPC](/consul/docs/reference/agent/configuration-file#grpc_port) must be enabled on all client agents.
