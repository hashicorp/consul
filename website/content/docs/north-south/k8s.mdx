...
- [Reroute HTTP requests in Kubernetes](/consul/docs/north-south/api-gateway/k8s/route-reroute-traffic)
- [Route traffic to peered services in Kubernetes](/consul/docs/north-south/api-gateway/k8s/route-route-peered)
