...
Configure individual services and health checks by specifying parameters in the `service` block of a service definition file. Refer to [Define Services](/consul/docs/discovery/services/usage/define-services) for information about defining services. 

To register a service, provide the service definition to the Consul agent. Refer to [Register Services and Health Checks](/consul/docs/discovery/services/usage/register-services-and-health-checks) for information about registering services. 
