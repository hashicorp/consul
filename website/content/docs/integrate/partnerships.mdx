...
[![HCP Consul Badge](/img/hcp_consul_partner_badge.png)](/img/hcp_consul_partner_badge.png | width=100)
...
> **Note**: The types of integration areas below could be developed to natively work with Consul or through leveraging Consul-Terraform-Sync and Consul’s network automation
> capabilities. 
