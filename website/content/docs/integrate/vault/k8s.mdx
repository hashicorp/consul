...
![Architectural diagram for Vault as Consul secrets manager](/img/consul/kubernetes-diagram-vault-as-secrets-manager.png)
...
![Permissions for Vault as Consul secrets manager](/img/consul/kubernetes-diagram-permissions-vault-as-secrets-manager.png)
...
[Helm Chart Configuration](/consul/docs/k8s/helm) page.
...
![Consul UI on services tab](/img/consul/kubernetes-consul_ui-services.png)
...
installation at [Helm Chart Configuration](/consul/docs/k8s/helm).
