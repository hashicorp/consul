...
[Federation Between Kubernetes Clusters](/consul/docs/link/wan-federation/k8s)
or [Federation Between VMs and Kubernetes](/consul/docs/link/wan-federation/k8s-vm)
