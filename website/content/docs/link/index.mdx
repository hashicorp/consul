...
For a complete list of documentation for a specific feature, refer to the following topics:

- [Cluster peering documentation](/consul/docs/link/cluster-peering#guidance)
- [WAN federation documentation](/consul/docs/link/wan-federation#guidance)
- [Mesh gateways documentation](/consul/docs/link/mesh-gateway#guidance)
