...
For general guidance for establishing cluster peering connections, refer to [Establish cluster peering connections](/consul/docs/link/cluster-peering/establish-connection/vm).
