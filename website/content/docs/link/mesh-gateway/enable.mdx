...
~> This topic requires familiarity with [mesh gateways](/consul/docs/link/mesh-gateway/federation).
...
When setting up a
[multi-datacenter](/consul/docs/link/wan-federation/create)
...
gateways](/consul/docs/link/mesh-gateway/federation) to do so.
...
only used for the [traditional federation process](/consul/docs/link/wan-federation#traditional-wan-federation).
