...
* Each datacenters must be [WAN joined](/consul/docs/link/wan-federation/create).
...
* If you want to [enable gateways globally](/consul/docs/link/mesh-gateway/federation#enabling-gateways-globally) you must enable [centralized configuration](/consul/docs/reference/agent#enable_central_service_config).
