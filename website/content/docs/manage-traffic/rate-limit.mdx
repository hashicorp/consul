...
Refer to the [service defaults configuration entry reference](/consul/docs/reference/config-entry/service-default) for additional specifications and example configurations.
