...
1. Apply the configuration. Refer to [Apply the configuration entry](/consul/docs/reference/proxy/envoy-extensions/usage/property-override#apply-the-configuration-entry) for details.
