...
To create a sameness group and configure each Consul datacenter to allow traffic from other members of the group, refer to [create sameness groups](/consul/docs/east-west/cluster-peering/usage/create-sameness-groups).
