---
layout: docs
page_title: Manage L7 traffic for Consul on Kubernetes with cluster peering connections
description: >-
...
# Manage L7 traffic for Consul on Kubernetes with cluster peering connections
