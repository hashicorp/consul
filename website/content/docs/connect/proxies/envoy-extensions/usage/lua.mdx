...
~> **Note:** Although you can apply Envoy extensions to `service-defaults`, this may have unintended consequences so we recommend using `proxy-defaults` in most cases.
