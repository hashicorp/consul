...
For more detailed guidance, refer to the [`learn-consul-apigee-external-authz`](https://github.com/hashicorp-education/learn-consul-apigee-external-authz) repo on GitHub.
