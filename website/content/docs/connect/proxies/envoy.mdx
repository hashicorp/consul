...
description: Consul service mesh has first-class support for configuring Envoy proxy.
---
...
that are currently controllable via Consul service mesh see [Dynamic
