...
> Complete the [Connect Services on Windows Workloads to Consul Service Mesh tutorial](/tutorials/consul/consul-on-windows-workloads) to learn how to deploy Consul and use its service mesh on Windows VMs.
