...
Consul Dataplane was introduced with Consul 1.14. It requires both Consul and Envoy to be at the
following versions. Each version of Consul Dataplane supports one specific version of Envoy.

| Consul Version      | Consul Dataplane Version | Required Envoy Version |
| ------------------- | ------------------------ | ---------------------- |
| 1.14.x              | 1.0                      | 1.23.1                 |
