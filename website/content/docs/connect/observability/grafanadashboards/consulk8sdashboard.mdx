...
description: >-
  This documentation provides an overview of the Consul on Kubernetes Dashboard
---

# Consul on Kubernetes control plane monitoring dashboard

This page provides reference information about the Grafana dashboard configuration included in [this GitHub repository](https://github.com/hashicorp/consul/blob/main/grafana/consul-k8s-control-plane-monitoring.json).
