...
If you are using Kubernetes, the Helm chart can simplify much of the [necessary
configuration](/docs/k8s/observability/metrics), which you can learn about in the [observability
