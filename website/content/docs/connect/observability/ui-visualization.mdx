...
visualizations. See our [Kubernetes observability docs](/docs/k8s/observability/metrics) for more information.
...
Similarly, to configure the UI on Kubernetes, use this [reference](/docs/k8s/observability/metrics).
