...
1. When configuring the Zipkin tracer in `envoy_tracing_json`, set `"trace_id_128bit": true` if your application is configured to generate 128-bit trace IDs. For example:
