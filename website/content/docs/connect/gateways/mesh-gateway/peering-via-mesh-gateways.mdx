...
In addition to service-to-service traffic routing, we recommend routing control plane traffic between cluster peers through mesh gateways to simplify networking requirements.
