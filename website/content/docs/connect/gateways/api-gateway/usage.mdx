...
## Introduction
Consul API gateways provide a configurable ingress points for requests into a Consul network. Configure the following configuration entries to set up API gateways: 
