...
1. Create a route configuration entry file and specify the following settings:
   ...
   Refer to the [HTTP route configuration entry](/consul/docs/connect/gateways/api-gateway/configuration/http-route) and [TCP route configuration entry](/consul/docs/connect/gateways/api-gateway/configuration/tcp-route) reference for details about configuring routes.
