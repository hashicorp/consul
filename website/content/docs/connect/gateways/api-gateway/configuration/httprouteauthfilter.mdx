---
layout: docs
page_title: HTTRouteAuthFilter configuration reference
description: Learn how to configure the `HTTRouteAuthFilter` resource, which defines behaviors for gateway listeners that are attached to specific HTTP routes.
---
