...
- [`Rules`](#rules): list | no default
  ...
  - [`Services`](#rules-services): list | no default
    ...
    - [`URLRewrite`](#rules-filters-urlrewrite): map | no default
      - [`Path`](#rules-urlrewrite-path): string | no default
    - [`Namespace`](#rules-namespace): string <EnterpriseAlert inline />
...
- [`Parents`](#parents): list | no default
  ...
  - [`Namespace`](#parents-namespace): string <EnterpriseAlert inline />
- [`Partition`](#parents-partition): string <EnterpriseAlert inline />
