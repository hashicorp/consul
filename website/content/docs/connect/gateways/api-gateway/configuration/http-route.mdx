...
Specifies the Enterprise [admin partition](/consul/docs/enterprise/admin-partitions) to apply to the config entry.
...
empty, this will bind this route to _all listeners_ on the parent gateway
