...
Specifies the Enterprise [namespace](/consul/docs/enterprise/namespaces) where the service can be found.
...
Specifies the Enterprise [admin partition](/consul/docs/enterprise/admin-partitions) where the service can be found.
...
Specifies the Enterprise [namespace](/consul/docs/enterprise/namespaces) where the parent can be found.
...
Specifies the Enterprise [admin partition](/consul/docs/enterprise/admin-partitions) where the parent can be found.
