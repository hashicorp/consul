...
Vault PKI can be managed by either Consul or by Vault. If you want to manually create and tune the PKI secret engines to be used as CA, use Vault Managed PKI Paths. If you want to have the PKI automatically managed for you, use Consul Managed PKI Paths.
