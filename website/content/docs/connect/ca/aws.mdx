---
layout: docs
page_title: AWS Certificate Manager Private CA as a Consul Service Mesh CA
description: >-
  Consul can be used with AWS Certificate Manager Private CA to manage and sign
  certificates.
---

# AWS Certificate Manager Private CA as a Consul Service Mesh CA

Consul can be used with [AWS Certificate Manager (ACM) Private Certificate Authority
(CA)](https://aws.amazon.com/certificate-manager/private-certificate-authority/)
to manage and sign service mesh certificates.

-> This page documents the specifics of the AWS ACM Private CA provider for Consul service mesh.
...
The ACM Private CA provider is enabled by setting the connect subsystem's CA provider to
...
Currently, the ACM Private CA provider has some additional
