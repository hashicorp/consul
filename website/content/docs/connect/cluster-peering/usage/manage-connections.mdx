...
The following example outputs information about a peering connection locally referred to as "dc2-default":
...
<Tab heading="HTTP API" group="api">
  ...
  ```shell-session
  $ curl --header "X-Consul-Token: b23b3cad-5ea1-4413-919e-c76884b9ad60" http://127.0.0.1:8500/v1/peering/dc2-default
  ```
...
<Tab heading="Consul CLI" group="cli">
  ...
  The following examples deletes a peering connection to a cluster locally referred to as "dc2-default":

  ```shell-session 
  $ consul peering delete -name dc2-default
  Successfully submitted peering connection, dc2-default, for deletion
  ```
...
<Tab heading="HTTP API" group="api">
  ...
  ```shell-session
  $ curl --request DELETE --header "X-Consul-Token: b23b3cad-5ea1-4413-919e-c76884b9ad60" http://127.0.0.1:8500/v1/peering/dc2-default
  ```
