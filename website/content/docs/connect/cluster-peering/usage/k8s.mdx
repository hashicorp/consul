...
Mesh gateways are required for cluster peering connections. To add mesh gateways to your deployment in order to use cluster peering complete the following steps:
