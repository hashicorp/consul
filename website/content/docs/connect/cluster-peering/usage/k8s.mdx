...
If you are new to using cluster peering, the following sections contain steps to configure environmental variables, update the Helm chart, and install the updated Helm chart on each cluster with Consul on Kubernetes.
