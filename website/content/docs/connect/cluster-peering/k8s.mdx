...
1. For the service in "cluster-02" that you want to export, add the following [annotation](/docs/k8s/annotations-and-labels) to your service's pods.
    ...
    <CodeBlockConfig filename="backend-service.yaml" highlight="38">
...
1. For the services in `cluster-01` that you want to access the "backend-service," add the following annotations to the service file.
    ...
    <CodeBlockConfig filename="frontend-service.yaml" highlight="37">
        ...
        spec:
          ...
          - name: frontend
            ...
            - name: "LISTEN_ADDR"
              value: "0.0.0.0:9090"
            - name: "UPSTREAM_URIS"
              value: "http://backend-service.svc.default.ns.cluster2.peer"
            - name: "NAME"
              value: "frontend"
            - name: "MESSAGE"
              value: "Hello World"
