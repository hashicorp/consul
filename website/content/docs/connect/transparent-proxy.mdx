...
annotation such as `"[consul.hashicorp.com/connect-service-upstreams](/docs/k8s/connect#consul-hashicorp-com-connect-service-upstreams)": "my-service:1234:dc2"` to reach an upstream
service called `my-service` in the datacenter `dc2`.
