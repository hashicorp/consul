...
| :------------------------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------                               | :--------------- | :------ |
| `consul_dataplane.connect_duration`          | Measures the time `consul-dataplane` spends getting connected to a Consul server. This is the entire time taken to discover Consul server addresses and to complete other setup, prior to Envoy opening the xDS stream. | ms               | timer   |
