...
Note that the examples in this topic use snake case, which is a convention that separates words with underscores, because the syntax is supported in configuration files and API registrations.
