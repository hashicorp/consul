...
Consul service mesh is the component shipped with Consul that enables service mesh functionality. The terms Consul Connect and Consul service mesh are used interchangeably throughout this documentation.
