...
Applications can use [sidecar proxies](/consul/docs/connect/proxy) in a service mesh configuration to
establish TLS connections for inbound and outbound connections without being aware of the service mesh at all. 
Applications may also [natively integrate with Consul service mesh](/consul/docs/automate/native) for optimal performance and security. 
...
enforce access control with [intentions](/consul/docs/secure-mesh/intention). This
