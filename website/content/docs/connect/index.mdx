...
Applications may also [natively integrate with Consul service mesh](/docs/connect/native) for optimal performance and security. 
...
- The [Secure Service-to-Service Communication tutorial](/consul/tutorials/developer-mesh/service-mesh-with-envoy-proxy?utm_source=docs)
  ...
  using Consul service mesh's built-in proxy and configuring your first intention. The guide also includes an introduction to
