...
>>>>>>> c5e729e865 (Docs/reformat service splitters conf entry (#16264))
---
...
<<<<<<< HEAD
This section provides details about the fields you can configure in the sservice splitter configuration entry.
=======
