...
<ConfigEntryReference
  keys={[
    ...
    {
      name: "Tracing",
      type: 'IngressTracingConfig: <optional>',
      description:
        'Specifies the tracing configuration to be used by the underlying http connection manager.',
      children: [
        {
          ...
          description: {
            hcl:
              "Sets the client_sampling value for the connection manager that underlies the listener for the gateway. This maps directly to the Envoy configuration value for [`client_sampling`](https://www.envoyproxy.io/docs/envoy/latest/api-v3/extensions/filters/network/http_connection_manager/v3/http_connection_manager.proto#extensions-filters-network-http-connection-manager-v3-httpconnectionmanager-tracing).",
            yaml:
              "Sets the client_sampling value for the connection manager that underlies the listener for the gateway. This maps directly to the Envoy configuration value for [`client_sampling`](https://www.envoyproxy.io/docs/envoy/latest/api-v3/extensions/filters/network/http_connection_manager/v3/http_connection_manager.proto#extensions-filters-network-http-connection-manager-v3-httpconnectionmanager-tracing).",
          },
        },
        {
           ...
           description: {
             hcl:
               "Sets the random_sampling value for the connection manager that underlies the listener for the gateway. This maps directly to the Envoy configuration value for [`random_sampling`](https://www.envoyproxy.io/docs/envoy/latest/api-v3/extensions/filters/network/http_connection_manager/v3/http_connection_manager.proto#extensions-filters-network-http-connection-manager-v3-httpconnectionmanager-tracing).",
             yaml:
               "Sets the random_sampling value for the connection manager that underlies the listener for the gateway. This maps directly to the Envoy configuration value for [`random_sampling`](https://www.envoyproxy.io/docs/envoy/latest/api-v3/extensions/filters/network/http_connection_manager/v3/http_connection_manager.proto#extensions-filters-network-http-connection-manager-v3-httpconnectionmanager-tracing).",
           },
        },
        {
           ...
           description: {
             hcl:
               "Sets the overall_sampling value for the connection manager that underlies the listener for the gateway. This maps directly to the Envoy configuration value for [`overall_sampling`](https://www.envoyproxy.io/docs/envoy/latest/api-v3/extensions/filters/network/http_connection_manager/v3/http_connection_manager.proto#extensions-filters-network-http-connection-manager-v3-httpconnectionmanager-tracing).",
             yaml:
               "Sets the overall_sampling value for the connection manager that underlies the listener for the gateway. This maps directly to the Envoy configuration value for [`overall_sampling`](https://www.envoyproxy.io/docs/envoy/latest/api-v3/extensions/filters/network/http_connection_manager/v3/http_connection_manager.proto#extensions-filters-network-http-connection-manager-v3-httpconnectionmanager-tracing).",
           },
         },
