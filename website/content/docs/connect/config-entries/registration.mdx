...
Specifies the datacenter to register the external service in.
...
Specifies a unique ID for the external service
...
Specifies the cloud region and zone where the service is available.
