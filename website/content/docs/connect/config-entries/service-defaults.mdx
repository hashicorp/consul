      ...
      children: [
        {
          ...
          children: [
            ...
            },
            {
              ...
              enterprise: true,
              description:
               'Specifies the admin partition to apply the configuration in. The current partition is used if unspecified. Refer to the [Admin Partitions documentation](/consul/docs/enterprise/admin-partitions) for details. The partitions parameter is not supported in Consul OSS.',
            },
            {
              name: 'Protocol',
              type: 'string: ""',
        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              ...
              enterprise: true,
              description:
               'Specifies the admin partition the configuration applies to. The current partition is used if unspecified. Refer to the [Admin Partitions documentation](/consul/docs/enterprise/admin-partitions) for details. The partitions parameter is not supported in Consul OSS.',
            },
            {
              name: 'Protocol',
              type: 'string: ""',
