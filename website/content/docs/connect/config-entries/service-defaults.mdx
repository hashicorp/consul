...
- [`UpstreamConfig`](#upstreamconfig): object | no default
  - [`Overrides`](#upstreamconfig-overrides): array of objects | no default
    ...
    - [`PassiveHealthCheck`](#upstreamconfig-overrides-passivehealthcheck): list of objects | optional
  ...
  - [`Defaults`](#upstreamconfig-defaults): array of objects | no default
    ...
    - [`PassiveHealthCheck`](#upstreamconfig-defaults-passivehealthcheck): list of objects | optional
...
- [`Destination`](#destination): list of objects | no default
  - [`Addresses`](#destination): array of strings | no default
