...
This topic provides conceptual information about the Consul catalog. The catalog tracks registered services and their locations for both service discovery and service mesh use cases.
