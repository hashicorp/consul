...
The web UI allows you to interact with Consul via a graphical user interface and view information about your Consul datacenter, including:
...
Consul uses [Access Control Lists](/consul/docs/secure/acl), or ACLs, to secure access to the web UI, API, CLI, service communications, and agent communications.
