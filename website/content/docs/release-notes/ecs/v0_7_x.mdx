...
- The new Dataplane architecture comes with the following breaking changes to configuring Consul on ECS. Refer to the [Upgrade to Consul dataplane architecture](/consul/docs/ecs/upgrade-to-dataplanes) documentation for a step-by-step upgrade guide.
