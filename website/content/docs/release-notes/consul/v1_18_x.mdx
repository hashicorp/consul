...
- **Consul Snapshot Agent support for multiple destinations (Enterprise):** Consul Enterprise users can now specifyy [multiple local and remote destinations](/consul/commands/snapshot/agent) for Consul snapshot backups.
