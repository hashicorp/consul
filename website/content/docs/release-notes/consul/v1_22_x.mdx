...
- **IPv6 address support**. This version introduces support for both IPv4 and IPv6 network addresses in agent and service configurations. Although both are supported, we recommend using only one address type per Consul datacenter.
