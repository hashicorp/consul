...
<CodeTabs heading="Consul watch with script handler defined in agent configuration"> <CodeBlockConfig filename="agent-config.hcl">
...
<CodeTabs heading="Consul watch with HTTP handler defined in agent configuration"> <CodeBlockConfig filename="agent-config.hcl">
...
</CodeBlockConfig> <CodeBlockConfig filename="agent-config.json">
