...
description: >-
  This topic provides an overview of Consul's key/value (KV) store and deployment strategies that use it to dynamically update applications and Consul configurations in response to deployment changes.
---
