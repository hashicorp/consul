...
[telemetry documentation](/consul/docs/agent/telemetry).

<Note>

 The AppDynamics Integration with HCP Consul collects a subset of 
Consul's default metrics that do not pertain to [server health](/consul/docs/agent/telemetry#server-health).
...
![AppDynamics CNS Custom Metrics Consul](/img/consul/cloud-integrations/appdynamics-ui-available-metrics-consul.png)
...
![AppDynamics CNS Custom Metrics Service Mesh ](/img/consul/cloud-integrations/appdynamics-ui-available-metrics-service-mesh.png)
...
![AppDynamics CNS Custom Dashboard Consul Metrics](/img/consul/cloud-integrations/appdynamics-ui-dashboard-consul.png)

![AppDynamics CNS Custom Dashboard Service Mesh Metrics](/img/consul/cloud-integrations/appdynamics-ui-dashboard-service-mesh.png)
...
![AppDynamics CNS custom health rules screen](/img/consul/cloud-integrations/appdynamics-ui-health-rules.png)
