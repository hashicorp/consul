...
bind to localhost by default if the [`addresses`](/consul/docs/reference/agent/configuration-file#addresses)
and [`client_addr`](/consul/docs/reference/agent/configuration-file#client_addr) config options are not
specified.
