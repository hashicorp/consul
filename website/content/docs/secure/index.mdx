  ...
  - Certificate Authority (Root & Intermediate)
    ...
    - Consul contains two different types of built-in Certificate Authorities: 
      ...
      certificates are created with the CLI as shown below.
        ...
        ```
      - [Consul service mesh CA](/consul/docs/connect/ca/consul) - this 
...
bind to localhost by default if the [`addresses`](/consul/docs/agent/config/config-files#addresses)
and [`client_addr`](/consul/docs/agent/config/config-files#client_addr) config options are not
specified.
...
Leverage Consul [intentions](/consul/docs/connect/intentions) 
...
* [Consul Security](/consul/docs/security)
...
* [Consul Intentions](/consul/docs/connect/intentions)
...
* [Consul Service Mesh Security](/consul/docs/connect/security) 
* [Consul Service Mesh CA](/consul/docs/connect/ca/consul)
