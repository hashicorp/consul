...
1. Assemble rules into [policies](/consul/docs/secure/acl/policies) and register them in Consul.
...
Refer to the [rules reference](/consul/docs/secure/acl/rules) for information about the rules in the policy.
