...
main [auth method documentation](/consul/docs/secure/acl/auth-methods).

Both the [`jwt`](/consul/docs/secure/acl/auth-methods/jwt) and the
[`oidc`](/consul/docs/secure/acl/auth-methods/oidc) auth method types allow additional
