...
See the [ACL Config Stanza](/consul/docs/reference/agent#acl) for more detailed descriptions of each option.
...
[data directory](/consul/docs/reference/agent#_data_dir). Any future changes to the token that are made through the [API](/consul/api-docs/agent#update-acl-tokens) will
