...
| Locality | Region and availability zone of the service. Refer to [`locality`](/consul/docs/reference/agent/configuration-file#locality) for more information. | Defined by user |
