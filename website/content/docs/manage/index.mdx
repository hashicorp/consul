...
If you lose access to a valid `global-management` token you need to reset the ACL system to regain access to your Consul datacenter. For more information, refer to [Reset Access Control List (ACL) system](/consul/docs/secure/acl/reset).