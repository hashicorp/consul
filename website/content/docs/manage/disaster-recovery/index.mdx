...
For more information about best practices and considerations for your own deployments, refer to [Disaster preparation strategy](/consul/docs/manage/disaster-recovery/disaster-preparation).
