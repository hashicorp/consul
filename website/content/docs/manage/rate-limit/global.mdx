...
- Set the rate limiter [`mode`](/consul/docs/reference/agent/configuration-file#mode-1)
- Set the [`read_rate`](/consul/docs/reference/agent/configuration-file#read_rate)
- Set the [`write_rate`](/consul/docs/reference/agent/configuration-file#write_rate)
