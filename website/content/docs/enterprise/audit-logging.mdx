...
logging, review the Consul [Audit Log](https://www.consul.io/docs/agent/config/agent-config-files#audit)
documentation.
...
the [`audit`](/docs/agent/config/agent-config-files#audit) stanza to the agent's configuration.
