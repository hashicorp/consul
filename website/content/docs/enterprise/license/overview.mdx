...
Virtual agents represent nodes on which Consul service mesh services are running and are used for the purposes of 
counting license entitlements and related billing in conjunction with node-based licensing and/or pricing.
