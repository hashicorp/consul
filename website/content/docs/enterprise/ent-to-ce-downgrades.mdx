...
reload the configuration:
   ...
   This change gives you more information to work with in the event something goes wrong.


1. Remove references to services in non-default namespaces and partitions from service resolver, service splitter, and service router configuration entries.
