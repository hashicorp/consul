...
All Consul clients must be able to communicate with the Consul servers for the assigned partition that is assigned to. All servers must also be able to communicate with the clients.
