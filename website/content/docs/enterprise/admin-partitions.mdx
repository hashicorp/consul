...
All Consul clients must be able to initiate Gossip, HTTP, and RPC connections to the servers. All servers must also be able to initiate Gossip connections to the clients.
