...
<<<<<<< HEAD:website/content/docs/api-gateway/usage.mdx

# Usage
=======
# Basic Consul API Gateway Usage
>>>>>>> ab51aac7e0 (Update docs for the release of Consul API Gateway v0.5 (#15015)):website/content/docs/api-gateway/usage/usage.mdx
