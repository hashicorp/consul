...
1. Install Consul API Gateway using the standard Consul Helm chart and specify the custom values file. Available versions of the Consul Helm chart can be found on in [GitHub releases](https://github.com/hashicorp/consul-k8s/releases).
