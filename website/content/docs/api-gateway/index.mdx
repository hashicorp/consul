...
This topic provides an overview of the Consul API Gateway for deploying on kubernetes. If you would like to deploy on virtual machines, refer to [API Gateways on Virtual Machines](/consul/docs/connect/gateways/api-gateway/overview).
