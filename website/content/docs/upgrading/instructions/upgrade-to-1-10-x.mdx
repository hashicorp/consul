...
and for [autopilot assisted upgrades](/consul/tutorials/datacenter-operations/upgrade-automation?utm_source=docs)
...
You can also refer to the [Apply Enterprise License](/consul/tutorials/production-deploy/deployment-guide?utm_source=docs#apply-enterprise-license) tutorial for additional information.
...
path involves first enabling ACLs by following [this tutorial](/consul/tutorials/security/access-control-setup-production?utm_source=docs)
