...
When upgrading to Consul 1.10, you must ensure that the Envoy sidecars are restarted
using a version of the Consul CLI >= 1.10. This ensures your sidecars are supported
by Consul 1.11.
