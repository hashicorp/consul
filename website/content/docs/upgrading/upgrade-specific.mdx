...
When this bug triggers, it will cause Envoy to incorrectly populate upstream endpoints. Due to this issue, it is recommended for
service mesh users running agent-less workloads to upgrade Consul to v1.16.2 or later.
