...
service-defaults are configured in each partition and namespace before upgrading. Doing so will ensure that no unexpected protocol changes occur during the upgrade.
