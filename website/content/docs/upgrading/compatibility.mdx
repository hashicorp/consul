...
## XDS Protocol Compatibility Table
...
| 0.6            | 1, 2, 3                                                                      |
| >= 0.7 <= 1.10 | 2, 3. Will automatically use protocol > 2 when speaking to compatible agents |
| 1.11+.         | 3                                                                            |

-> **Note:** Regarding XDS protocol changes See https://developer.hashicorp.com/consul/docs/upgrading/upgrade-specific#envoy-xds-protocol-upgrades-1 for details.
