...
[`consul agent`](/commands/agent) command like this:
...
[`consul members`](/commands/members) against each agent and noting
...
run [`consul members`](/commands/members) against each agent,
