...
- [`/session`](/consul/api-docs/session): Create and manage [sessions](/consul/docs/dynamic-app/sessions) in Consul. You can use sessions to build distributed and granular locks to ensure nodes are properly writing to the Consul KV store.
