...
[federated either directly or via mesh gateways](/consul/docs/link/mesh-gateway/enable).
...
[`dns_config.allow_stale`]: /consul/docs/reference/agent#allow_stale
[`dns_config.max_stale`]: /consul/docs/reference/agent#max_stale
[`discovery_max_stale`]: /consul/docs/reference/agent#discovery_max_stale
