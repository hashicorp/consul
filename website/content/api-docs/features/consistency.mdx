...
[redundancy zones](/consul/docs/manage/redundancy-zone) or
[read replicas](/consul/docs/manage/read-replica)
...
[`dns_config.allow_stale`]: /consul/docs/reference/agent/configuration-file#allow_stale
[`dns_config.max_stale`]: /consul/docs/reference/agent/configuration-file#max_stale
[`discovery_max_stale`]: /consul/docs/reference/agent/configuration-file#discovery_max_stale
