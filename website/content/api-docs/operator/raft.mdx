...
This endpoint transfers the raft leadership from the current raft leader to a different raft peer.
The new leader will be randomly selected unless explicitly specified with the `id` parameter.
