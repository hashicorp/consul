...
Please check the [Network Areas tutorial](/consul/docs/link/network-area) for more details.
...
- `Protocol` is the [protocol version](/consul/docs/upgrade#protocol-versions)
