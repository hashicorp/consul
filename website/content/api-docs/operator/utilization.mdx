...
The `/operator/utilization` endpoints provide tools generate a Consul utilization bundle for license reporting.

Please check the [Manual license utilization reporting documentation](/consul/docs/enterprise/license/reporting#manual-license-utilization-reporting) for more details.
