...
[service mesh proxy integrations](/consul/docs/integrate/proxy). Future
...
- `compile-dc` `(string: "")` - Specifies the datacenter to use as the basis of
  ...
  configuration](/consul/docs/reference/proxy/connect-proxy#upstream-configuration-reference).
...
- `OverrideProtocol` `(string: "")` - Overrides the final
  [protocol](/consul/docs/reference/config-entry/service-default#protocol) used in
...
- `OverrideMeshGateway` `(MeshGatewayConfig: <optional>)` - Overrides the final
  [mesh gateway configuration](/consul/docs/link/mesh-gateway/#connect-proxy-configuration)
  for this any service resolved in the compiled chain.

  This value comes from the `mesh_gateway` parameter in either the [proxy
  configuration](/consul/docs/reference/proxy/connect-proxy#proxy-parameters) or [upstream
  configuration](/consul/docs/reference/proxy/connect-proxy#upstream-configuration-reference)
