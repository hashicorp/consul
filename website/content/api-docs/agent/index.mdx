...
- `prune` `(bool: false)` - Specifies whether to forcibly remove the node from
  the LAN and WAN gossip pools. This is specified as part of the URL as
  a query parameter. Added in Consul 1.6.2.
