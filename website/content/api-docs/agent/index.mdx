...
[`prometheus_retention_time`](/consul/docs/reference/agent/configuration-file#telemetry-prometheus_retention_time).
...
only if the [`acl.enable_token_persistence`](/consul/docs/reference/agent/configuration-file#acl_enable_token_persistence)
...
[`default`](/consul/docs/reference/agent/configuration-file#acl_tokens_default), [`agent`](/consul/docs/reference/agent/configuration-file#acl_tokens_agent),
[`agent_recovery`](/consul/docs/reference/agent/configuration-file#acl_tokens_agent_recovery),
[`config_file_service_registration`](/consul/docs/reference/agent/configuration-file#acl_tokens_config_file_service_registration),
and [`replication`](/consul/docs/reference/agent/configuration-file#acl_tokens_replication).
...
The paths above correspond to the token names as found in the agent configuration:
[`agent_master`](/consul/docs/reference/agent/configuration-file#acl_tokens_agent_master).
...
The paths above correspond to the token names as found in the agent configuration:
[`acl_token`](/consul/docs/reference/agent/configuration-file#acl_token_legacy), [`acl_agent_token`](/consul/docs/reference/agent/configuration-file#acl_agent_token_legacy),
[`acl_agent_master_token`](/consul/docs/reference/agent/configuration-file#acl_agent_master_token_legacy), and
[`acl_replication_token`](/consul/docs/reference/agent/configuration-file#acl_replication_token_legacy).
