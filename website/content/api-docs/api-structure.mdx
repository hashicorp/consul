...
[`translate_wan_addrs`](/consul/docs/reference/agent/configuration-file/#translate_wan_addrs). In order
...
[`acl.default_policy`](/consul/docs/reference/agent/configuration-file#acl_default_policy) option.
