...
[`translate_wan_addrs`](/consul/docs/reference/agent#translate_wan_addrs). In order
...
[`acl.default_policy`](/consul/docs/reference/agent#acl_default_policy) option.

This is also the default [intention](/consul/docs/secure-mesh/intentions) enforcement
