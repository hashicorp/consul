...
[intentions](/consul/docs/secure-mesh/intentions).

-> **1.9.0 and later:** Reading and writing intentions has been
migrated to the
[`service-intentions`](/consul/docs/reference/config-entry/service-intention)
config entry kind.
...
| ---------------- | ----------------- | ------------- | ------------------------------ |
| `NO`             | `none`            | `none`        | `intentions:write` <p> Define intention rules in the `service` policy. Refer to [ACL requirements for intentions](/consul/docs/secure-mesh/intentions/create#acl-requirements) for additional information.</p> |
...
- `Permissions` `(array<IntentionPermission>)` - The list of all [additional L7
  attributes](/consul/docs/reference/config-entry/service-intention#intentionpermission)
  ...
  policy](/consul/docs/reference/agent#acl_default_policy).
...
| Blocking Queries | Consistency Modes | Agent Caching | ACL Required                  |
| ---------------- | ----------------- | ------------- | ----------------------------- |
| `YES`            | `all`             | `none`        | `intentions:read`<p> Define intention rules in the `service` policy. Refer to [ACL requirements for intentions](/consul/docs/secure-mesh/intentions/create#acl-requirements) for additional information.</p> |
...
| Blocking Queries | Consistency Modes | Agent Caching | ACL Required                  |
| ---------------- | ----------------- | ------------- | ----------------------------- |
| `NO`             | `none`            | `none`        | `intentions:read`<p> Define intention rules in the `service` policy. Refer to [ACL requirements for intentions](/consul/docs/secure-mesh/intentions/create#acl-requirements) for additional information.</p> |
...
| Blocking Queries | Consistency Modes | Agent Caching        | ACL Required                  |
| ---------------- | ----------------- | -------------------- | ----------------------------- |
| `YES`            | `all`             | `background refresh` | `intentions:read`<p> Define intention rules in the `service` policy. Refer to [ACL requirements for intentions](/consul/docs/secure-mesh/intentions/create#acl-requirements) for additional information.</p> |
