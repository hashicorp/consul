...
- `DisableGossip` `(bool: false)` - Disable gossip communication for this partition. When set to `true`, server agents use fewer CPU and network resources but client agents cannot join the partition.
