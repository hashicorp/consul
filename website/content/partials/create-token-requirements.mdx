...
```shell-session
$ export CONSUL_HTTP_TOKEN=<acl_token_secret_id>
```
...
To learn about alternative ways to authenticate, refer to the [CLI](/consul/commands#authentication) or [API](/consul/api-docs/api-structure#authentication) documentation.
