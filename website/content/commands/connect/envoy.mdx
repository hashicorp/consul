...
This command configures and launches an [Envoy proxy](https://envoyproxy.io)
for use with Consul's [service mesh](/docs/connect/) capabilities.
...
- `-bootstrap` - If present, the command will simply output the generated
  ...
  allowed to access by service mesh [intentions](/docs/connect/intentions).
