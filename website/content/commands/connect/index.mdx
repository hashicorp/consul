...
description: >-
  The `consul connect` command interacts with Consul's service mesh features. It interacts with the internal CA and service mesh proxies, exposes services through ingress gateways, and applies iptables rules.
---
