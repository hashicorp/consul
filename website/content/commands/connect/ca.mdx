...
description: >
  The connect CA subcommand is used to view and modify the service mesh Certificate
...
Usage: consul connect ca <subcommand> [options] [args]
  ...
  Certificate Authority (CA) managed by the connect subsystem.
...
Subcommands:
    get-config    Display the current service mesh CA configuration
