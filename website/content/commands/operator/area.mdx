...
See the [Network Areas Guide](/consul/docs/link/network-area) for more details.
...
`Protocol` is the [protocol version](/consul/docs/upgrade#protocol-versions) being
spoken by the node.
