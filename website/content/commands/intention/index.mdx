...
[intentions](/consul/docs/secure-mesh/intentions). It exposes commands for
creating, updating, reading, deleting, checking, and managing intentions.
This command is available in Consul 1.2 and later.

Use the 
[`service-intentions`](/consul/docs/reference/config-entry/service-intention) configuration entry or the [HTTP
