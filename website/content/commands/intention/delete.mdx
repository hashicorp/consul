...
| ACL Required                   |
| ------------------------------ |
| `intentions:write`<p> Define intention rules in the `service` policy. Refer to [ACL requirements for intentions](/consul/docs/secure-mesh/intentions/create#acl-requirements) for additional information.</p> |
