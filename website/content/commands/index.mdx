...
When the [ACL system is enabled](/consul/docs/reference/agent#acl) the Consul CLI will
...
explicitly](/consul/docs/reference/agent#grpc_port) in agent configuration.
