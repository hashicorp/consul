...
- `-consumerPeer=<string>` - If provided, output is filtered to only services which have the consumer peer.

- `-consumerPartition` <EnterpriseAlert inline /> - If provided, output is filtered to only services which have the consumer partition
