...
To create a filter expression, you will write one or more expressions. Each expression has a matching operators composed of selectors and values.
...
Numbers can be any
base 10 integers and floating point numbers are possible. 
