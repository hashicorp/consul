...
## OIDC Authorization URL Request <EnterpriseAlert inline/> <sup>Beta</sup>
...
## OIDC Callback <EnterpriseAlert inline /> <sup>Beta</sup>
...
- `Namespace` `(string: "")` <EnterpriseAlert inline /> - Specifies the namespace of
  ...
  This must match the namespace provided on the [OIDC Callback](#oidc-callback-beta).
