...
- Writing Consul-Terraform-Sync compatible Terraform modules [guide](https://www.consul.io/docs/nia/installation/requirements#how-to-create-a-compatible-terraform-module)
