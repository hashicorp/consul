...
- `-segment` ((#\_segment)) <span class="label-enterprise">Enterprise</span> - This flag is used to set
...
- `-non-voting-server` ((#\_non_voting_server)) <span class="label-enterprise">Enterprise</span> - This
...
- `acl` ((#acl)) - This object allows a number of sub-keys to be set which
  ...
  - `tokens` ((#acl_tokens)) - This object holds all of the configured
    ...
    - `managed_service_provider` ((#acl_tokens_managed_service_provider)) <span class="label-enterprise">Enterprise</span> - An
...
- `autopilot` Added in Consul 0.8, this object allows a
  ...
  - `redundancy_zone_tag` <span class="label-enterprise">Enterprise</span> -
  ...
  - `disable_upgrade_migration` <span class="label-enterprise">Enterprise</span> -
  ...
  - `upgrade_version_tag` <span class="label-enterprise">Enterprise</span> -
...
- `dns_config` This object allows a number of sub-keys
  ...
  - `prefer_namespace` ((#dns_prefer_namespace)) <span class="label-enterprise">Enterprise</span> -
...
- `segment` <span class="label-enterprise">Enterprise</span> - Equivalent to the [`-segment` command-line flag](#_segment).

- `segments` <span class="label-enterprise">Enterprise</span> - This is a list of nested objects
