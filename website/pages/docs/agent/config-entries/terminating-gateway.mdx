...
Link a gateway with the billing service:
...
Link a gateway with all services in the pci namespace, and verify destination
...
Link a gateway with all services in the finance namespace, and configure default certificates for mutual TLS.
