...
-> **Note:** In versions earlier to Consul 1.8, the discovery chain is only used to discover
[Connect](/docs/connect) proxy upstreams. 
From Consul 1.8 onwards, also Envoy sidecar proxies use the discovery chain. 
