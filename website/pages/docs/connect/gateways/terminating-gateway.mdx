...
services outside the mesh, review the [terminating gateway guide](https://learn.hashicorp.com/tutorials/consul/teminating-gateways-connect-external-services).
...
[external services guide](https://learn.hashicorp.com/tutorials/consul/service-registration-external-services).
