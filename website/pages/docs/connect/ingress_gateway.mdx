...
1. On a host dedicated to the gateway and Consul client, start an Envoy proxy using the [envoy
...
Ingress gateways are defined in service configuration files and registered with Consul like other services, with two exceptions.
