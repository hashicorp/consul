...
![Consul UI Service Mesh Visualization](/img/connect-ui-vizualization.png)
...
-> **Note**: the URL is wrapped over multiple lines to make it easier to read without
horizontal scrolling in the example above however this needs to be a normal
single-line string value in actual HCL config.
...
[Single Sign-On
integration](/docs/security/acl/auth-methods/oidc) (Consul
