...
For additional use-cases and usage patterns, review the
[understand terminating gateways guide](https://learn.hashicorp.com/consul/developer-mesh/terminating-gateways).
