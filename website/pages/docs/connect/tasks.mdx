...
## Service-to-service traffic between service datacenters
...
As of Consul 1.8.0, mesh gateways can send all forms of traffic, including gossip and RPC communication between
Consul servers. This is enabled by [WAN federation via mesh gateways](https://www.consul.io/docs/connect/wan-federation-via-mesh-gateways).

For more information mesh gateways see the [mesh gateway documentation](https://www.consul.io/docs/connect/mesh-gateway)
...
For more information ingress gateways see the [complete documentation](https://www.consul.io/docs/connect/ingress-gateway)
...
For more information terminating gateways see the [complete documentation](https://www.consul.io/docs/connect/terminating-gateway)
