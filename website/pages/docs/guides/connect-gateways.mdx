...
Lastly you should set [`enable_central_service_config = true`](/docs/agent/options.html#enable_central_service_config)
...
Kubernetes documentation](/docs/platform/k8s/helm.html)
