...
module.exports = {
  ...
  sources: [
    ...
    {
      root: `${path.dirname(require.resolve('@hashicorp/consul-acls/package.json'))}/app/components`,
      pattern: '**/README.mdx',
      urlSchema: 'auto',
      urlPrefix: 'docs/consul-acls',
    },
    {
      root: `${path.dirname(require.resolve('@hashicorp/consul-lock-sessions/package.json'))}/app/components`,
      pattern: '**/README.mdx',
      urlSchema: 'auto',
      urlPrefix: 'docs/consul-lock-sessions',
    },
    {
      root: `${path.dirname(require.resolve('@hashicorp/consul-peerings/package.json'))}/app/components`,
      pattern: '**/README.mdx',
      urlSchema: 'auto',
      urlPrefix: 'docs/consul-peerings',
    },
    {
      root: `${path.dirname(require.resolve('@hashicorp/consul-partitions/package.json'))}/app/components`,
      pattern: '**/README.mdx',
      urlSchema: 'auto',
      urlPrefix: 'docs/consul-partitions',
    },
    {
      root: `${path.dirname(require.resolve('@hashicorp/consul-nspaces/package.json'))}/app/components`,
      pattern: '**/README.mdx',
      urlSchema: 'auto',
