...
much logic required in a new component. And if there is, and it's important
enough to need testing, you should consider splitting the logic off and
testing it outside of the component via integration testing and/or
