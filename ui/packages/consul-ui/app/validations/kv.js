...
function validateNoSuspiciousExtensions(options = {}) {
  const suspiciousExtensions = [
    'js', 'php', 'asp', 'aspx', 'jsp', 'exe', 'bat', 
    'cmd', 'sh', 'py', 'pl', 'rb', 'cgi', 'html', 
    'htm', 'xml', 'json'
  ];
...
export default {
  Key: [
    ...
    validateFormat({ 
      regex: /^[a-zA-Z0-9,\-_./]+$/, 
      message: 'Key can only contain letters, numbers, commas, hyphens, underscores, periods, and forward slashes' 
    }),
    validateNoSpaces(),
