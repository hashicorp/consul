...
func New(destinationsCache *sidecarproxycache.DestinationsCache, proxyCfgCache *sidecarproxycache.ProxyConfigurationCache, identitiesCache *sidecarproxycache.IdentitiesCache) *Mapper {
	return &Mapper{
