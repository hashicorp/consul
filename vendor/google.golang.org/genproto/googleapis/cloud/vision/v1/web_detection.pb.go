...
func (*WebDetection) Descriptor() ([]byte, []int) {
	return fileDescriptor_web_detection_4e5f575acd9ec7d5, []int{0}
}
...
func (*WebDetection_WebEntity) Descriptor() ([]byte, []int) {
	return fileDescriptor_web_detection_4e5f575acd9ec7d5, []int{0, 0}
}
...
func (*WebDetection_WebImage) Descriptor() ([]byte, []int) {
	return fileDescriptor_web_detection_4e5f575acd9ec7d5, []int{0, 1}
}
...
func (*WebDetection_WebPage) Descriptor() ([]byte, []int) {
	return fileDescriptor_web_detection_4e5f575acd9ec7d5, []int{0, 2}
}
...
func (*WebDetection_WebLabel) Descriptor() ([]byte, []int) {
	return fileDescriptor_web_detection_4e5f575acd9ec7d5, []int{0, 3}
}
...
func init() {
	proto.RegisterFile("google/cloud/vision/v1/web_detection.proto", fileDescriptor_web_detection_4e5f575acd9ec7d5)
}

var fileDescriptor_web_detection_4e5f575acd9ec7d5 = []byte{
