...
func (ClusterOperationStatus_State) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_operations_06b6b1222ad2529d, []int{0, 0}
}
...
func (*ClusterOperationStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_operations_06b6b1222ad2529d, []int{0}
}
...
func (*ClusterOperationMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_operations_06b6b1222ad2529d, []int{1}
}
...
func init() {
	proto.RegisterFile("google/cloud/dataproc/v1beta2/operations.proto", fileDescriptor_operations_06b6b1222ad2529d)
}

var fileDescriptor_operations_06b6b1222ad2529d = []byte{
