...
func (*Backend) Descriptor() ([]byte, []int) {
	return fileDescriptor_backend_6a3ac2605e71ddff, []int{0}
}
...
func (*BackendRule) Descriptor() ([]byte, []int) {
	return fileDescriptor_backend_6a3ac2605e71ddff, []int{1}
}
...
func init() { proto.RegisterFile("google/api/backend.proto", fileDescriptor_backend_6a3ac2605e71ddff) }

var fileDescriptor_backend_6a3ac2605e71ddff = []byte{
