...
func (_m *ResourceService_WatchListServer) Send(_a0 *resourcev1.WatchEvent) error {
	ret := _m.Called(_a0)
...
func (_c *ResourceService_WatchListServer_Send_Call) Run(run func(_a0 *resourcev1.WatchEvent)) *ResourceService_WatchListServer_Send_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*resourcev1.WatchEvent))
	})
	return _c
}
...
func (_c *ResourceService_WatchListServer_Send_Call) RunAndReturn(run func(*resourcev1.WatchEvent) error) *ResourceService_WatchListServer_Send_Call {
	_c.Call.Return(run)
	return _c
}
