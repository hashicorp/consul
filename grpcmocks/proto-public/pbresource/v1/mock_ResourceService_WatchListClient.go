...
func (_m *ResourceService_WatchListClient) Recv() (*resourcev1.WatchEvent, error) {
	ret := _m.Called()

	var r0 *resourcev1.WatchEvent
	var r1 error
	if rf, ok := ret.Get(0).(func() (*resourcev1.WatchEvent, error)); ok {
		return rf()
	}
	if rf, ok := ret.Get(0).(func() *resourcev1.WatchEvent); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*resourcev1.WatchEvent)
		}
	}
...
func (_c *ResourceService_WatchListClient_Recv_Call) Return(_a0 *resourcev1.WatchEvent, _a1 error) *ResourceService_WatchListClient_Recv_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *ResourceService_WatchListClient_Recv_Call) RunAndReturn(run func() (*resourcev1.WatchEvent, error)) *ResourceService_WatchListClient_Recv_Call {
	_c.Call.Return(run)
	return _c
}
