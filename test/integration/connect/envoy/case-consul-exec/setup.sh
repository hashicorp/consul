...
# Bring up s2 and it's proxy as well because the check that it has a cert causes
...
export REQUIRED_SERVICES="s1-sidecar-proxy-consul-exec s2 s2-sidecar-proxy"