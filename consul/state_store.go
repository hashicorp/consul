...
func (s *StateStore) initialize() error {
	...
	s.queryTables = map[string]MDBTables{
		...
		"NodeInfo":          MDBTables{s.nodeTable, s.serviceTable, s.checkTable, s.archetypeTable},
		"NodeDump":          MDBTables{s.nodeTable, s.serviceTable, s.checkTable, s.archetypeTable},
