...
func (s *StateStore) initialize() error {
	...
	s.queryTables = map[string]MDBTables{
		...
		"NodeInfo":          {s.nodeTable, s.serviceTable, s.checkTable},
		"NodeDump":          {s.nodeTable, s.serviceTable, s.checkTable},
		"KVSGet":            {s.kvsTable},
		"KVSList":           {s.kvsTable},
		"KVSListKeys":       {s.kvsTable},
		"SessionGet":        {s.sessionTable},
		"SessionList":       {s.sessionTable},
		"NodeSessions":      {s.sessionTable},
		"ACLGet":            {s.aclTable},
		"ACLList":           {s.aclTable},
	}
	return nil
