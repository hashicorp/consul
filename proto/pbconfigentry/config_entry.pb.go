...
type UpstreamConfig struct {
	...
	// mog: func-to=PassiveHealthCheckToStructs func-from=PassiveHealthCheckFromStructs
...
// This type is not used by mog because of the naming mismatch in the EnforcingConsecutive5xx field
// (the go struct field name generated by protoc is EnforcingConsecutive5Xx).
// For this reason, the conversion is done manually instead.
