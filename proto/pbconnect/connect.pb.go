...
var file_proto_pbconnect_connect_proto_goTypes = []any{
...
func file_proto_pbconnect_connect_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_pbconnect_connect_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_proto_pbconnect_connect_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*CARoot); i {
			case 0:
				return &v.state
			case 1:
		...
		file_proto_pbconnect_connect_proto_msgTypes[2].Exporter = func(v any, i int) any {
