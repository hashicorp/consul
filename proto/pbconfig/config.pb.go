...
type TLS struct {
	...
	//
	// Deprecated: Marked as deprecated in proto/pbconfig/config.proto.
...
var file_proto_pbconfig_config_proto_goTypes = []any{
...
func file_proto_pbconfig_config_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_pbconfig_config_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Config); i {
			case 0:
				return &v.state
			case 1:
		...
		file_proto_pbconfig_config_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Gossip); i {
			case 0:
				return &v.state
			case 1:
		...
		file_proto_pbconfig_config_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_proto_pbconfig_config_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*TLS); i {
			case 0:
				return &v.state
			case 1:
		...
		file_proto_pbconfig_config_proto_msgTypes[4].Exporter = func(v any, i int) any {
			switch v := v.(*ACL); i {
			case 0:
				return &v.state
			case 1:
		...
		file_proto_pbconfig_config_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_proto_pbconfig_config_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_proto_pbconfig_config_proto_msgTypes[7].Exporter = func(v any, i int) any {
