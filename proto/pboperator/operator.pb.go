...
var file_proto_pboperator_operator_proto_goTypes = []any{
...
func file_proto_pboperator_operator_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_pboperator_operator_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_proto_pboperator_operator_proto_msgTypes[1].Exporter = func(v any, i int) any {
