...
type PeeringTrustBundle struct {
	...
	ExportedPartition string `protobuf:"bytes,7,opt,name=ExportedPartition,proto3" json:"ExportedPartition,omitempty"`
...
var file_proto_pbpeering_peering_proto_rawDesc = []byte{
	...
	0x6f, 0x72, 0x74, 0x65, 0x64, 0x50, 0x61, 0x72, 0x74, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x07,
	...
	0x65, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x18, 0x05, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0b, 0x43, 0x72,
	0x65, 0x61, 0x74, 0x65, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x12, 0x20, 0x0a, 0x0b, 0x4d, 0x6f, 0x64,
	0x69, 0x66, 0x79, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x18, 0x06, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0b,
...
var file_proto_pbpeering_peering_proto_depIdxs = []int32{
	...
	31, // 10: peering.EstablishRequest.Meta:type_name -> peering.EstablishRequest.MetaEntry
	...
	24, // 18: peering.PeeringService.Establish:input_type -> peering.EstablishRequest
	...
	25, // 27: peering.PeeringService.Establish:output_type -> peering.EstablishResponse
