...
type Peering struct {
	...
	// ManualServerAddresses indicates whether the PeerServerAddresses were manually specified by
	// a user and should not be automatically updated.
	ManualServerAddresses bool `protobuf:"varint,18,opt,name=ManualServerAddresses,proto3" json:"ManualServerAddresses,omitempty"`
}
...
func (x *Peering) GetManualServerAddresses() bool {
	if x != nil {
...
var file_proto_pbpeering_peering_proto_rawDesc = []byte{
	...
	0x76, 0x65, 0x72, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x65, 0x73, 0x18, 0x12, 0x20, 0x01,
	0x28, 0x08, 0x52, 0x15, 0x4d, 0x61, 0x6e, 0x75, 0x61, 0x6c, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72,
