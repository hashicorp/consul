...
var file_proto_pbsubscribe_subscribe_proto_goTypes = []any{
...
func file_proto_pbsubscribe_subscribe_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_pbsubscribe_subscribe_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_proto_pbsubscribe_subscribe_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_proto_pbsubscribe_subscribe_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*Event); i {
			case 0:
				return &v.state
			case 1:
		...
		file_proto_pbsubscribe_subscribe_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_proto_pbsubscribe_subscribe_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_proto_pbsubscribe_subscribe_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_proto_pbsubscribe_subscribe_proto_msgTypes[6].Exporter = func(v any, i int) any {
	...
	file_proto_pbsubscribe_subscribe_proto_msgTypes[1].OneofWrappers = []any{
		(*SubscribeRequest_WildcardSubject)(nil),
		(*SubscribeRequest_NamedSubject)(nil),
	}
	file_proto_pbsubscribe_subscribe_proto_msgTypes[2].OneofWrappers = []any{
