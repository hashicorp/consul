...
const (
	...
	// InferenceGateway topic contains events for changes to inference-gateway config entries.
	Topic_InferenceGateway Topic = 20
)
...
const file_private_pbsubscribe_subscribe_proto_rawDesc = "" +
	...
	"\bPeerName\x18\x04 \x01(\tR\bPeerName*\xa1\x03\n" +
	"\x05Topic\x12\v\n" +
	...
	"\x0fGlobalRateLimit\x10\x13\x12\x14\n" +
	"\x10InferenceGateway\x10\x14*)\n" +
	"\tCatalogOp\x12\f\n" +
