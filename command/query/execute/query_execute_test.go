...
func TestQueryExecute_noTabs(t *testing.T) {
	t.Parallel()
...
func TestQueryExecute(t *testing.T) {
	...
	var result api.PreparedQueryExecuteResponse
	output := ui.OutputWriter.Bytes()
	require.NoError(t, json.Unmarshal(output, &result))
	require.Equal(t, "web", result.Service)
}

func TestQueryExecute_InvalidArgs(t *testing.T) {
	t.Parallel()
